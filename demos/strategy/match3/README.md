...
- `luna.render.rectangle()` — drawing the grid cells, UI panels, and gem backgrounds
- `luna.render.circle()` — rendering circular gem shapes with highlight rings
- `luna.render.print()` — score, combo counter, and move display
- `luna.mousepressed()` — selecting and swapping adjacent gems
- `luna.render.setColor()` — six distinct gem colours plus special-gem overlays
