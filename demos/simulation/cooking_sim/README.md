...
- `luna.render.rectangle()` — station footprints, plate display, and order timer bars
- `luna.render.setColor()` — per-ingredient colour coding and stove burn state
- `luna.render.print()` — live on-screen feedback messages and score/money HUD
...
- `luna.render.circle()` — chef avatar and ingredient held-in-hand indicator
- `luna.render.setBackgroundColor()` — warm kitchen atmosphere
