...
- `luna.render.rectangle()` — floor grid, room panels with type-colour fill, elevator shaft
- `luna.render.setColor()` — room-type palette lookup and occupancy tint overlay
- `luna.render.print()` — floor labels, room icons, money HUD, and daily revenue summary
- `luna.render.setBackgroundColor()` — sky gradient behind the tower
