...
## Repo rules
- `docs/api/lurek.md` and `docs/api/lurek.lua` are generated â€” never hand-edit them. Fix errors in `src/lua_api/<module>_api.rs` Rust docstrings, then regenerate: `python tools/docs/gen_lua_api_data.py` then `python tools/docs/gen_luadoc.py`.
