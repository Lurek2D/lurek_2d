...
## Repo rules
- Architecture authority chain: binding constraints â†’ engine structure â†’ module contracts â†’ CAG layer. Each tier may restrict but not contradict its parent.
...
- The five module tiers in order: Foundations â†’ Core Runtime â†’ Platform Services â†’ Feature Systems â†’ Edge/Integration. Any import going from a higher tier to a lower tier is valid.
