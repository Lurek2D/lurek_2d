...
- Generated data under `extension/vscode/src/generated/` comes from `python tools/docs/gen_extension_api.py`. Never hand-edit generated files Ă˘â‚¬â€ť fix the generator or its data source.
