...
- `docs/api/lurek.lua` and `docs/api/lurek.md` are generated â€” never hand-edit them. Always fix docstring issues in `src/lua_api/<module>_api.rs`, then regenerate with `python tools/gen_all_docs.py`.
