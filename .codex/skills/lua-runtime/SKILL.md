...
- LuaJIT `ffi` is available and useful for tight numerical loops, but ffi types must not cross the Lua-Rust boundary through mlua â€” they are LuaJIT internal types and cause crashes on the Rust side.
