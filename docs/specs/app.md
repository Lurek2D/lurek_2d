...
- This central shell is also what makes recovery possible: startup failures, callback errors, and shutdown transitions can be surfaced through one engine-owned policy instead of leaking platform behavior directly to scripts.
