...
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_01_procgen_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_02_procgen_move_costs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_03_mapblock_to_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_04_mapblock_write_report.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_05_tileset_object_semantics.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_06_tileset_catalog_refs.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_07_sprite_atlas_manifest.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_08_tilemap_from_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_09_tilemap_render_adapters.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_10_pathfind_route.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_11_pathfind_range.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_12_pathfind_fov.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_13_awareness_players.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_14_awareness_team.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_15_awareness_cone.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_16_awareness_line_channels.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_17_tilelight_point_blockers.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_18_tilelight_many_sources.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_19_tilelight_line_area.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_20_tilelight_global_multilevel.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_21_tilelight_source_lifecycle.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_22_fog_light_minimap.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_23_fieldmap_chunks.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_24_procgen_mapblock_overlay.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_hex_systems_25_final_maptile_render.png` |
...
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_01_procgen_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_02_procgen_move_costs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_03_mapblock_to_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_04_mapblock_write_report.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_05_tileset_object_semantics.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_06_tileset_catalog_refs.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_07_sprite_atlas_manifest.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_08_tilemap_from_refs.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_09_tilemap_render_adapters.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_10_pathfind_route.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_11_pathfind_range.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_12_pathfind_flow.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_13_awareness_players.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_14_awareness_team.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_15_awareness_cone.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_16_awareness_line_channels.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_17_tilelight_point_blockers.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_18_tilelight_many_sources.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_19_tilelight_line_area.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_20_tilelight_global_multilevel.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_21_tilelight_source_lifecycle.txt` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_22_fog_light_minimap.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_23_fieldmap_chunks.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_24_procgen_mapblock_overlay.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_25_final_maptile_render.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_26_iso_xcom_slot_logic.png` |
| Baseline artifact | `tests/artifacts/baselines/tilefield/tilefield_systems_26_iso_xcom_slot_logic.txt` |
