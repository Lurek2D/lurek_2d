...
Provides vectors, matrices, spatial indexes (AABB tree and spatial hash), and polygon geometry. - Supports splines, Bézier curves, tweens with easing, seedable randoms, and loot pity-trackers. - Centralizes core mathematical formulas to guarantee consistent, drift-free engine behaviors.
...
do
    ...
    lurek.log.info(tostring("remap(5, 0-10 -> 0-100) = " .. v))
