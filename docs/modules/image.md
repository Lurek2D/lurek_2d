...
Manages CPU image buffers, PNG texture loading, layered stacks, palette remapping, and atlases. - Supports pixel-level effects, nine-slices, compatibility province-grid ingest, and graphical debug visualizations.
