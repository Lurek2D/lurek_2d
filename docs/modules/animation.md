...
| Name | Type | Description |
|------|------|-------------|
| `animated` | [LAnimatedImage](image.md#lanimatedimage) | Decoded animated image. |
...
Creates an animation from a `[LSpriteSheet](sprite.md#lspritesheet)`, optionally using a named group.
...
| Name | Type | Description |
|------|------|-------------|
| `sheet` | [LSpriteSheet](sprite.md#lspritesheet) | Source sprite sheet. |
