...
Manages engine shared state, asset registries, and configurations. - Supports headless or windowed modes and stable error codes. - Reports frame profiling, memory budgets, and locale messages.
