...
Simulates pooled particles with rich shapes, gravity forces, and collider bounces. - Supports keyframe curves, tapered ribbon trails, sub-emitters, and diagnostic images.
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the lifecycle chart. |
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the explosion preview. |
...
| Name | Type | Description |
|------|------|-------------|
| `image` | [LImageData](render.md#limagedata) | Background image data handle. |

**Returns**

| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the composited result. |
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the rain preview. |
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the spark preview. |
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the rendered particles. |
...
| Name | Type | Description |
|------|------|-------------|
| `image` | [LImageData](render.md#limagedata) | Target image data handle. |
...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | Image data containing the rendered trail. |
