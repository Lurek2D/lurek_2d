...
Grid terminal supporting ANSI formats, syntax highlighting, and cycling tab-completions. - Cell widgets with input focus, scrollback history, and pixel-perfect rendering.
