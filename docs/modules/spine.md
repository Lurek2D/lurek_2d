...
Simulates skeletal rigs using bone hierarchies, slots, skin swaps, and target IK. - Builds multi-bone animation tracks from tables and can bind posed rig parts into physics bodies and joints.
