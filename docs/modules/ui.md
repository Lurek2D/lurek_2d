...
| Type | Description |
|------|-------------|
| [LImageData](render.md#limagedata) | The rendered image. |
...
| Type | Description |
|------|-------------|
| [LFont](render.md#lfont) | Current global UI font handle. |
...
| Type | Description |
|------|-------------|
| [LFont](render.md#lfont) | Font override assigned to the widget. |
...
| Name | Type | Description |
|------|------|-------------|
| `font` | [LFont](render.md#lfont) | Font handle used by the UI when widgets do not override it. |
...
do
    ...
    lurek.log.info(tostring("isVertical:") .. " " .. tostring(vert) .. " " .. tostring("thickness:") .. " " .. tostring(thick) .. " " .. tostring("->") .. " " .. tostring(t2))
end
```
...
| Name | Type | Description |
|------|------|-------------|
| `font` | [LFont](render.md#lfont) | Font handle to use for this widget subtree. |
