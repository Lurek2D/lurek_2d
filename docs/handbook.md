...
| [content/](../content/)                     | Lua content — `games/` (showcase apps), `examples/` (one-file API demos), `layouts/`, `plugins/`, `snippets/`, and `zips/`. |
