...
---@class library.particle_presets
library.particle_presets = {}

--- Retrieve a preset configuration table by name. Returns a deep copy so the caller can mutate freely. Optional overrides are merged on top of the preset defaults.
---@param name string
---@param overrides table
---@return table
function library.particle_presets.get(name, overrides) end

--- Create a particle emitter from a preset and position it. Wraps lurek.particle.newEmitter and calls setPosition on the result.
---@param name string
---@param x number
---@param y number
---@param overrides table
---@return userdata|table
function library.particle_presets.spawn(name, x, y, overrides) end

--- List all registered preset names.
---@return table
function library.particle_presets.list() end

--- Register a custom preset definition. lifetime, speed, angle, size, color, fadeOut, gravity, spread, acceleration, spin.
---@param name string
---@param config table
---@return nil
function library.particle_presets.register(name, config) end

---@class province_economy
library.province_economy = {}

--- Initialize economy state for a province
---@param province_id number
---@param opts table|nil
---@return nil
function library.province_economy.initProvince(province_id, opts) end

--- Calculate food needed by population
---@param province_id number
---@param config table|nil
---@return any
function library.province_economy.foodNeed(province_id, config) end

--- Calculate base tax gold
---@param province_id number
---@param config table|nil
---@return any
function library.province_economy.baseTax(province_id, config) end

--- Get happiness productivity multiplier
---@param province_id number
---@param config table|nil
---@return any
function library.province_economy.happinessMultiplier(province_id, config) end

--- Calculate population cap
---@param province_id number
---@param config table|nil
---@return any
function library.province_economy.populationCap(province_id, config) end

--- Resolve one monthly economic tick for a province
---@param province_id number
---@param config table|nil
---@return any
function library.province_economy.monthlyTick(province_id, config) end

--- Resolve monthly tick for all provinces in a list
---@param province_ids table
---@param config table|nil
---@return any
function library.province_economy.monthlyTickAll(province_ids, config) end
...
function library.scene_objects.new() end

--- Add an object to the container. Objects missing a `layer` field are treated as layer 0.
---@param obj table
---@return nil
...
---@param obj table
---@return nil
function ObjectContainer:remove(obj) end

--- Remove all objects from the container.
---@return nil
function ObjectContainer:clear() end

--- Call `obj:update(dt)` on every object that has an `update` method. Objects are updated in insertion order.
---@param dt number
---@return nil
...
---@return nil
function ObjectContainer:draw() end

--- Return the number of objects currently in the container.
---@return number
function ObjectContainer:count() end

--- Return all objects on a specific layer.
---@param n number
---@return table
function ObjectContainer:getByLayer(n) end
