...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-06-24*
*Coverage: 6249/6249 functions documented (100.0%)*
...
- [`lurek.raycaster`](#raycaster) — 16 fn, 6 classes
...
lurek.raycaster.buildMultiLevelSceneFromField( params : table, field : LTileField, opts : table?, lights : table?, sprites : table|LSpriteManager?, wallTextures : table? ) -> integer  -- Builds a multilevel raycaster scene from a tilefield blocker channel
...
*Coverage: 431/431 items documented (100%)*
