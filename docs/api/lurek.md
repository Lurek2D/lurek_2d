...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-06-25*
*Coverage: 6273/6273 functions documented (100.0%)*

---

## Contents

- [`lurek.render`](#render) — 116 fn, 12 classes
...
- [`lurek.pathfind`](#pathfind) — 26 fn, 13 classes
...
lurek.render.printRichWithFont( font : LFont, spans : table, x : number, y : number )  -- Draws rich text using a specific font without changing the global active font
...
*Coverage: 191/191 items documented (100%)*
