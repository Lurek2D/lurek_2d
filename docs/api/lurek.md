...
*Coverage: 6158/6158 functions documented (100.0%)*

---

## Contents

- [`lurek.render`](#render) — 117 fn, 12 classes
...
- [`lurek.sprite`](#sprite) — 8 fn, 5 classes
...
```lua
LBoxPlotChart:addSeries( name : any, values : any, color : any )  -- Adds or replaces a named distribution sample series
LBoxPlotChart:appendValue( name : any, value : any, color : any )  -- Appends one numeric sample to a named distribution
...
```lua
LBubbleChart:addSeries( name : any, data : any, color : any )  -- Adds or replaces a weighted point series from `{x, y, size}` rows
LBubbleChart:appendPoint( name : any, x : any, y : any, size : any, color : any )  -- Appends one weighted point to a named bubble series
...
LBubbleChart:setRadiusRange( min : any, max : any )  -- Sets the minimum and maximum bubble radius in pixels
...
```lua
LCandlestickChart:appendCandle( label : any, open : any, high : any, low : any, close : any )  -- Appends one labeled OHLC candle to the end of the current candlestick stream
...
LCandlestickChart:setCandles( candles : any )  -- Replaces all OHLC candles from table rows with open/high/low/close fields or values 1..4
LCandlestickChart:setColors( up : any, down : any )  -- Sets up/down candle colors
...
```lua
LRadarChart:addSeries( name : any, values : any, color : any )  -- Adds or replaces a named radar series
...
LRadarChart:setAxes( axes : any )  -- Replaces radar axis labels
LRadarChart:setMaxValue( value : any )  -- Sets the explicit maximum radial value
...
```lua
LTreemapChart:addItem( label : any, value : any, color : any )  -- Adds one weighted treemap item
...
LTreemapChart:setItems( items : any )  -- Replaces weighted treemap items from label/value rows or fields
...
> Registers the `lurek.tilefield` Lua API for multi-level tile gameplay semantics. The binding layer converts Lua tables and one-based coordinates while the Rust domain module owns field behavior.
...
lurek.tilefield.new( opts : table ) -> LTileField  -- Creates a multi-level tilefield
```
...
LTileField:applyProfile( x : any, y : any, z : any, name : any )  -- Applies a named profile to one cell
LTileField:blocks( x : any, y : any, z : any, channel : any )  -- Returns whether a cell blocks a channel
LTileField:clear()  -- Clears all cell gameplay state and computed light values
LTileField:clearCell( x : integer, y : integer, z : integer? )  -- Clears one cell
LTileField:clearLine( from_tbl : any, to_tbl : any, channel : any, opts : any )  -- Returns true when the line between two cell tables has no blocker for a channel
LTileField:clearPointLights()  -- Removes all point lights
LTileField:computeLight( opts : table? )  -- Computes tile light from ambient, point lights, and global top light
LTileField:exportBlockLayer( channel : any, z : any )  -- Exports one blocker channel and level as a row-major boolean array
LTileField:exportCostLayer( channel : any, z : any )  -- Exports one cost channel and level as a row-major number array
...
LTileField:firstBlocker( from_tbl : any, to_tbl : any, channel : any, opts : any )  -- Returns the first one-based blocking cell table between two cells, or nil
...
LTileField:getCost( x : any, y : any, z : any, channel : any )  -- Returns the cost for one cell/channel
...
LTileField:getSunOcclusion( x : any, y : any, z : any )  -- Returns top-light occlusion in the inclusive range 0..1
...
LTileField:removeProfile( name : string )  -- Removes a named object profile
LTileField:setBlock( x : any, y : any, z : any, channel : any, blocked : any )  -- Sets whether a cell blocks a channel
...
LTileField:setCost( x : any, y : any, z : any, channel : any, cost : any )  -- Sets the cost for one cell/channel
LTileField:setGlobalLight( opts : table )  -- Sets top-down global light
LTileField:setProfile( name : any, profile_tbl : any )  -- Registers or replaces a named object profile
LTileField:setSunOcclusion( x : any, y : any, z : any, value : any )  -- Sets top-light occlusion in the inclusive range 0..1
...
LTileField:updatePointLight( id : any, opts : any )  -- Updates an existing point light by id
```
...
```lua
LTileVisibility:actionCells( player : any, z : any )  -- Returns all currently actionable cells for a player, optionally filtered to a level
LTileVisibility:canActOn( player : any, x : any, y : any, z : any )  -- Returns whether a one-based cell is currently actionable for a player
LTileVisibility:clearAll()  -- Clears current, explored, and action masks for all players
LTileVisibility:clearPlayer( player : any )  -- Clears current, explored, and action masks for one player
LTileVisibility:computeAction( player : any, opts : any )  -- Computes one player's current action mask from a tilefield origin
LTileVisibility:computeVisible( player : any, opts : any )  -- Computes one player's current visible mask from a tilefield origin
LTileVisibility:isExplored( player : any, x : any, y : any, z : any )  -- Returns whether a one-based cell has been explored for a player
LTileVisibility:isVisible( player : any, x : any, y : any, z : any )  -- Returns whether a one-based cell is currently visible for a player
LTileVisibility:type()  -- Returns the Lua-visible type name for this tile visibility handle
LTileVisibility:typeOf( name : any )  -- Returns whether this handle matches a supported type name
LTileVisibility:visibleCells( player : any, z : any )  -- Returns all currently visible cells for a player, optionally filtered to a level
```
