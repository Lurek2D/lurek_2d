...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-07-20*
*Coverage: 6993/7103 functions documented (98.5%)*
...
- [`lurek.province`](#province) — 15 fn, 1 class
...
```lua
LUiWidget:addChild( child : LUiWidget|integer )  -- Adds a child widget to this widget's hierarchy
...
LUiWidget:removeChild( child : LUiWidget|integer )  -- Removes a child widget from this widget's hierarchy
