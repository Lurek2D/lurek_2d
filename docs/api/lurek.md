...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.0.0` | Generated: 2026-05-25*
*Coverage: 5182/5182 functions documented (100.0%)*
...
```lua
lurek.validator.newEngine()  -- Create a new LValidationEngine for running schema and constraint checks
