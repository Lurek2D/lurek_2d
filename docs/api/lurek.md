...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-07-26*
*Coverage: 7112/7233 functions documented (98.3%)*

---

## Contents

- [`lurek.render`](#render) — 125 fn, 13 classes
- [`lurek.window`](#window) — 55 fn
- [`lurek.input`](#input) — 108 fn, 4 classes
- [`lurek.time`](#timer) — 21 fn, 1 class
- [`lurek.math`](#math) — 99 fn, 14 classes
...
- [`lurek.tilemap`](#tilemap) — 14 fn, 5 classes
- [`lurek.dialog`](#dialog) — 12 fn, 5 classes
- [`lurek.ecs`](#ecs) — 22 fn, 7 classes
...
- [`lurek.flownet`](#flownet) — 1 fn, 4 classes
...
- [`lurek.network`](#network) — 27 fn, 1 class
...
- [`lurek.serialize`](#serialize) — 18 fn
- [`lurek.spine`](#spine) — 4 fn, 2 classes
- [`lurek.sprite`](#sprite) — 12 fn, 6 classes
- [`lurek.svg`](#svg) — 1 fn, 1 class
- [`lurek.terminal`](#terminal) — 31 fn, 2 classes
- [`lurek.tilefield`](#tilefield) — 6 fn, 2 classes
...
lurek.render.applyShaderToCanvas( canvas : LCanvas, shader : LShader, opts : table? ) -> LCanvas  -- Queues a postfx shader pass that mutates a canvas render target after queued canvas draws in the current frame
...
lurek.render.setDebugShader( shader : LShader? )  -- Activates a debugviz-target WGSL shader for subsequent diagnostic/debug draw commands. Pass nil to restore the normal draw shader state
...
lurek.render.setTextShader( shader : LShader? )  -- Activates a text-target WGSL shader for subsequent font-atlas text draws. Pass nil to restore default text rendering
...
*Coverage: 263/263 items documented (100%)*
...
*Coverage: 336/347 items documented (97%)*
...
*Coverage: 141/141 items documented (100%)*
