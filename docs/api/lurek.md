...
*Coverage: 6994/7104 functions documented (98.5%)*

---

## Contents

- [`lurek.render`](#render) — 124 fn, 12 classes
...
*Coverage: 217/217 items documented (100%)*
...
*Coverage: 326/326 items documented (100%)*
...
LAtlasPacker:pack( name : string, w : integer, h : integer ) -> boolean  -- Packs a named region into this atlas and returns whether allocation succeeded
