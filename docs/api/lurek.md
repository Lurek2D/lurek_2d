...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-06-27*
*Coverage: 6400/6405 functions documented (99.9%)*

---

## Contents

- [`lurek.render`](#render) — 118 fn, 12 classes
...
- [`lurek.raycaster`](#raycaster) — 17 fn, 6 classes
- [`lurek.repl`](#repl) — 1 fn, 1 class
- [`lurek.serialize`](#serialize) — 16 fn
- [`lurek.shader`](#shader) — 1 fn
...
*Coverage: 209/209 items documented (100%)*
...
*Coverage: 125/125 items documented (100%)*
...
*Coverage: 96/96 items documented (100%)*
...
> Registers the `lurek.shader` Lua API for target-aware WGSL shader handles. The shader namespace is a thin public constructor layer over the shared render shader store. Rendering modules decide where validated shader targets may be bound; this file only parses options, constructs shaders, and returns handles.

*Coverage: 1/1 items documented (100%)*

```lua
lurek.shader.new( code : string, opts : table? ) -> LShader  -- Compiles a target-aware WGSL fragment shader and returns a shader handle
```
...
*Coverage: 476/476 items documented (100%)*
