...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-06-23*
*Coverage: 6185/6185 functions documented (100.0%)*
...
- [`lurek.tilefield`](#tilefield) — 3 fn, 2 classes
...
LTileSet:getPhysicsShape( tileId : integer ) -> string  -- Returns the physics shape name associated with this tile
LTileSet:getProfile( tileId : integer ) -> string  -- Returns the tilefield profile name associated with this tile
LTileSet:getProperties( tileId : integer ) -> table  -- Returns all gameplay properties associated with this tile
LTileSet:getProperty( tileId : integer, name : string ) -> string  -- Returns an arbitrary gameplay property associated with this tile
LTileSet:getPropertyBool( tileId : integer, name : string ) -> boolean  -- Returns an arbitrary gameplay property parsed as a boolean
LTileSet:getPropertyNumber( tileId : integer, name : string ) -> number  -- Returns an arbitrary gameplay property parsed as a number
...
LTileSet:setPhysicsShape( tileId : integer, shape : string? )  -- Assigns or clears the physics shape name associated with this tile
LTileSet:setProfile( tileId : integer, profile : string? )  -- Assigns or clears the tilefield profile name associated with this tile
LTileSet:setProperty( tileId : integer, name : string, value : string? )  -- Assigns or clears an arbitrary gameplay property associated with this tile
...
*Coverage: 189/189 items documented (100%)*
...
lurek.pathfind.newNavGridFromField( field_ud : LTileField, opts : table? ) -> LNavGrid  -- Creates a navigation grid from a tilefield level and channel
...
lurek.pathfind.rangeMapFromField( field_ud : LTileField, opts : table ) -> table  -- Computes reachable cells from a tilefield level and movement channel
...
LTileAwareness:visibleCells( player : string, z : integer? ) -> table  -- Returns all currently visible cells for a player, optionally filtered to a level
```
...
```lua
lurek.tilefield.fromTileMap( tilemap : LTileMap, opts : table? ) -> LTileField  -- Copies a tilemap layer into a tilefield, optionally applying profiles and a ref slot
...
```lua
LTileField:applyProfile( x : integer, y : integer, z : integer?, name : string )  -- Applies a named profile to one cell
LTileField:applyTilesetProfile( x : integer, y : integer, z : integer?, slot : string, tileset : LTileSet, opts : table? ) -> boolean  -- Applies the tilefield profile named by a tileset tile referenced from one cell
LTileField:applyTilesetStats( x : integer, y : integer, z : integer?, slot : string, tileset : LTileSet, opts : table? ) -> boolean  -- Applies tileset gameplay properties for a tile referenced from one cell
LTileField:applyTilesetStatsLayer( slot : string, tileset : LTileSet, opts : table? ) -> integer  -- Applies tileset gameplay properties for every referenced cell on one tilefield level
...
LTileField:exportProfileLayer( z : integer? )  -- Exports one level of profile names as a row-major array
...
LTileField:getCell( x : integer, y : integer, z : integer? ) -> table  -- Returns a table with blockers, costs, sun occlusion, and optional profile name
...
LTileField:getProfile( name : string ) -> table|nil  -- Returns a named object profile table, or nil when absent
LTileField:getRef( x : integer, y : integer, z : integer?, slot : string ) -> integer|nil  -- Returns a named object/tile reference from one cell, or nil
...
LTileField:removeProfile( name : string )  -- Removes a named object profile from the tilefield profile registry
...
LTileField:setCell( x : integer, y : integer, z : integer?, cell : table )  -- Sets cell state from a table with optional `blocks`, `costs`, `sunOcclusion`, and `profile`
LTileField:setCost( x : integer, y : integer, z : integer?, channel : string, cost : number )  -- Sets the cost for one cell/channel
LTileField:setProfile( name : string, profile_tbl : table )  -- Registers or replaces a named object profile
LTileField:setRef( x : integer, y : integer, z : integer?, slot : string, value : integer )  -- Sets a named object/tile reference on one cell
...
LTileField:writeProfileLayer( z : integer?, values : table )  -- Writes one full profile-name layer from a row-major string-or-nil array
...
```lua
lurek.tilelight.compute( field : LTileField, opts : table? ) -> LTileLightMap  -- Creates and computes a tile light map for a shared tilefield
lurek.tilelight.new( field : LTileField ) -> LTileLightMap  -- Creates a tile light map attached to a shared tilefield
```
...
LTileLightMap:exportLayer( z : integer? )  -- Exports one level of computed light as row-major `{r,g,b,luma}` tables
LTileLightMap:exportVolume()  -- Exports all computed light levels as nested row-major tables
LTileLightMap:getLight( x : integer, y : integer, z : integer? )  -- Returns r, g, b, and luma for one cell
LTileLightMap:getSize()  -- Returns light-map width, height, and level count
LTileLightMap:removeLineLight( id : any )  -- Removes a line light by id and returns whether it existed
...
LTileLightMap:setGlobalLight( opts : table )  -- Sets top-down global light parameters used during light computation
