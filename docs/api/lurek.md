...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-06-07*
*Coverage: 5758/5761 functions documented (99.9%)*
...
lurek.audio.pauseAll( path : string, opts : table? )  -- Plays a music track, routing through a named group with optional fade-in
...
*Coverage: 22/25 items documented (88%)*
