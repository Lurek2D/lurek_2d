...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-07-16*
*Coverage: 6987/7097 functions documented (98.5%)*
...
- [`lurek.physics`](#physics) — 27 fn, 8 classes
...
- [`lurek.light`](#light) — 22 fn, 2 classes
...
*Coverage: 325/325 items documented (100%)*
...
```lua
lurek.tilefield.createLightsFromTileset( field : LTileField, slot : string, tileset : LTileSet, opts : table? ) -> table  -- Creates normal render lights and occluders from tilefield refs whose tileset objects define `renderLight` or `occluder`
lurek.tilefield.createPhysicsFromTileset( field : LTileField, slot : string, tileset : LTileSet, world : LWorld, opts : table? ) -> LBody[]  -- Creates physics bodies from tilefield refs whose tileset objects define `physics`
...
LTileField:beginEdit()  -- Clears pending dirty rectangles before a grouped tilefield edit
...
LTileField:clear()  -- Clears all gameplay state, modifiers, and references in the field
...
LTileField:commitEdit( chunkSize : integer? ) -> table  -- Clears and returns dirty rectangles accumulated since `beginEdit`
...
LTileField:restore( snapshot : table )  -- Replaces this tilefield state from a snapshot returned by `snapshot`
