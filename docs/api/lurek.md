...
*Coverage: 6418/6423 functions documented (99.9%)*
...
*Coverage: 255/255 items documented (100%)*
...
LWorld:getFlowField( id : integer ) -> table?  -- Returns one flow field table by id, or nil when missing
