...
*Coverage: 6470/6475 functions documented (99.9%)*
...
*Coverage: 101/106 items documented (95%)*
...
lurek.ecs.getProperty( this : any, name : any )
...
lurek.ecs.isA( this : any, candidate : any )
...
lurek.ecs.setProperty( this : any, name : any, value : any )
lurek.ecs.type( this : any )
lurek.ecs.typeOf( this : any, candidate : any )
```
...
LTileField:removeRegion( name : string ) -> boolean  -- Removes a named region
