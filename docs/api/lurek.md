...
*Coverage: 6405/6410 functions documented (99.9%)*
...
```lua
LFlowField:destroy()  -- Disables this flow field
...
LFlowField:setApplication( mode : string )  -- Sets the body-application mode used during stepping
LFlowField:setCombine( mode : string )  -- Sets how this field combines with overlapping fields
LFlowField:setEnabled( enabled : boolean )  -- Enables or disables this flow field
LFlowField:setLayerMask( mask : integer )  -- Sets the body-layer mask that this field affects
LFlowField:setPoints( points : table )  -- Replaces the polyline points of a path-shaped flow field
LFlowField:setStrength( strength : number )  -- Sets this flow field strength
LFlowField:setWidth( width : number )  -- Sets the width of a path-shaped flow field
LFlowField:type() -> string  -- Returns the type name of this object
LFlowField:typeOf( name : string ) -> boolean  -- Returns whether this object matches the requested type name
```
...
LWorld:addFlowField( opts : table ) -> LFlowField  -- Creates one authored flow field and returns a handle for later mutation
