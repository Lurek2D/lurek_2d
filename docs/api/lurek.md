...
*Coverage: 6431/6436 functions documented (99.9%)*
...
- [`lurek.audio`](#audio) — 94 fn, 7 classes
...
- [`lurek.image`](#image) — 14 fn, 6 classes
...
- [`lurek.learning`](#learning) — 21 fn, 19 classes
- [`lurek.light`](#light) — 20 fn, 2 classes
- [`lurek.mapblock`](#mapblock) — 10 fn, 10 classes
- [`lurek.midi`](#midi) — 4 fn
- [`lurek.network`](#network) — 30 fn, 3 classes
...
*Coverage: 251/251 items documented (100%)*
...
lurek.midi.loadSoundFont( path : string ) -> boolean  -- Loads a SoundFont (SF2) file into the global MIDI state for synthesis
lurek.midi.newPlayer( path : string? ) -> LMidiPlayer  -- Creates a new MIDI player instance, optionally loading a file immediately
```
