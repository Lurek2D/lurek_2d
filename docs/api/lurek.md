...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.1.0` | Generated: 2026-07-01*
*Coverage: 6475/6475 functions documented (100.0%)*
...
```lua
LFlowStream:destroy()  -- Disables this flow field
...
LFlowStream:setStrength( strength : number )  -- Sets this flow field strength
...
LWorld:removeFlowField( id : integer ) -> boolean  -- Disables one flow field by id
...
```lua
LImageShaderJob:cancel()  -- Cancels this image shader job
...
lurek.ecs.getProperty( name : string, name : any )  -- Returns the current value of one object property, honoring any registered getter override first
...
lurek.ecs.isA( candidate : string, candidate : any ) -> boolean  -- Returns whether this object inherits from or matches the supplied ECS class name
...
lurek.ecs.setProperty( name : string, value : any, value : any )  -- Writes one object property, delegating to a registered setter override when the property defines one
lurek.ecs.type( this : any ) -> string  -- Returns the registered ECS class name for this object table
lurek.ecs.typeOf( candidate : string, candidate : any ) -> boolean  -- Returns whether this object matches a supported Lua-visible type or ECS class name
```
...
LDeck:draw( count : integer? )  -- Draw one or more cards from the top of the draw pile
LDeck:isEmpty() -> boolean  -- Return true when no cards remain in the draw pile
LDeck:peek( count : integer? )  -- Inspect one or more cards from the top without removing them
...
LTileAwareness:defineCategory( name : any, opts : any )  -- Defines or replaces one awareness category
...
LTileAwareness:isAware( player : any, category : any, x : any, y : any, z : any )  -- Returns whether a one-based cell is visible for a specific awareness category
...
LTileAwareness:setTeam( players : any, categories : any )  -- Creates directed share edges between all listed players for selected categories
LTileAwareness:share( from : any, to : any, category : any, opts : any )  -- Adds a directed awareness share edge for one category
...
LTileAwareness:visibleCells( player : string, z : integer?, z : any ) -> table  -- Returns all currently visible cells for a player, optionally filtered to a level
```
...
LAnimatedCursor:setPulse( min_scale : number, max_scale : number, speed : number )  -- Set the pulse animation speed and scale factor parameters
LAnimatedCursor:update( dt : number )  -- Update animation (call each frame)
```
...
```lua
LCursorManager:addRule( ctx : string, cursor_name : string )  -- Add a context rule that maps a context to a system cursor
...
LCursorManager:enableLineTrail( r : number, g : number, b : number, width : number )  -- Enable cursor trail with line mode
LCursorManager:enableTrail( r : number, g : number, b : number, lifetime : number )  -- Enable cursor trail with fade points mode
LCursorManager:enableZoom( magnification : number, radius : number )  -- Enable zoom/magnifier at cursor position
...
LCursorManager:update( x : number, y : number, dt : number )  -- Update cursor state (call each frame)
```
...
LCustomCursor:getPixel( x : integer, y : integer ) -> integer  -- Get the pixel color at the specified cursor image position
LCustomCursor:getSize() -> integer  -- Get the pixel width and height of the cursor image
LCustomCursor:setPixel( x : integer, y : integer, r : integer, g : integer, b : integer, a : integer )  -- Set a pixel color â€” Lua userdata object exposed by the engine
```
...
LGlobe:removeTerrainPatch( id : integer ) -> boolean  -- Removes a terrain patch by id
...
*Coverage: 136/136 items documented (100%)*
...
LTileField:blocksCategory( x : any, y : any, z : any, category : any )  -- Returns whether one cell blocks a category
LTileField:clear()  -- Clears all cell gameplay state
...
LTileField:footprintPassable( x : any, y : any, z : any, w : any, h : any, category : any )  -- Returns whether a rectangular footprint can occupy a cell anchor for a category
...
LTileField:getCategoryCost( x : any, y : any, z : any, category : any )  -- Returns one effective category cost
LTileField:getCategoryFilter( x : any, y : any, z : any, category : any )  -- Returns one effective RGB category filter
LTileField:getCategoryTransmission( x : any, y : any, z : any, category : any )  -- Returns one effective category transmission multiplier
...
LTileField:setCategoryBlock( x : any, y : any, z : any, category : any, blocked : any )  -- Sets one category blocker on one cell
LTileField:setCategoryCost( x : any, y : any, z : any, category : any, cost : any )  -- Sets one category cost on one cell
LTileField:setCategoryFilter( x : any, y : any, z : any, category : any, filter : any )  -- Sets one RGB category filter on one cell
LTileField:setCategoryTransmission( x : any, y : any, z : any, category : any, value : any )  -- Sets one category transmission multiplier on one cell
...
LTileLightMap:addRectLight( opts : table|`{x,y,z?,width|w,height ) -> integer  -- Alias for `addAreaLight`
...
LTileLightMap:clearRectLights()  -- Alias for `clearAreaLights`
...
LTileLightMap:removeRectLight( id : integer ) -> boolean  -- Alias for `removeAreaLight`
...
LTileLightMap:updateRectLight( id : integer, opts : table )  -- Alias for `updateAreaLight`
```
...
LPropertyWidget:addProperty( group : integer, name : string, value : any, valueType : string?, options : table?, readOnly : boolean? ) -> integer  -- Adds a property row to a group
