...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.0.0` | Generated: 2026-05-22*
*Coverage: 4883/4883 functions documented (100.0%)*
...
*Coverage: 420/420 items documented (100%)*
...
lurek.ui.getStyleToken( name : string )  -- Returns the value of a named semantic style token from the active theme
