...
*Coverage: 6999/7109 functions documented (98.5%)*
...
- [`lurek.filesystem`](#filesystem) — 44 fn, 2 classes
...
- [`lurek.image`](#image) — 15 fn, 7 classes
...
*Coverage: 121/121 items documented (100%)*
...
lurek.ui.loadLayoutGameFile( path : string ) -> integer  -- Loads a UI layout from a TOML file resolved through GameFS
...
LStatusBar:setSectionWidget( section_idx : integer, widget : table? )  -- Associates a widget with a status bar section (reserved for future use)
```
