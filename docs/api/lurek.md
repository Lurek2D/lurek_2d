...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.0.0` | Generated: 2026-05-16*
...
LGraph:astar( from_node : LGraphNode, to_node : LGraphNode )  -- Runs A* pathfinding between two nodes
...
LGraph:findPath( from_ud : LGraphNode, to_ud : LGraphNode )  -- Finds a path between two nodes. This method is available to Lua scripts
LGraph:findPathForItem( item_ud : LGraphItem, from_ud : LGraphNode, to_ud : LGraphNode )  -- Finds a path for a specific item between two nodes while respecting item constraints
LGraph:getComponents() -> table  -- Returns connected components as arrays of node handles
LGraph:getDistance( from_ud : LGraphNode, to_ud : LGraphNode )  -- Returns graph distance between two nodes when reachable
LGraph:getEdgeBetween( from_ud : LGraphNode, to_ud : LGraphNode )  -- Returns the edge connecting two nodes when one exists
