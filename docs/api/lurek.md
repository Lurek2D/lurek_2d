...
*Auto-generated by `tools/gen_docs_lua.py`. Version: `1.0.0` | Generated: 2026-05-21*
*Coverage: 4856/4856 functions documented (100.0%)*

---

## Contents

- [`lurek.render`](#render) — 122 fn, 12 classes
...
*Coverage: 210/210 items documented (100%)*
...
lurek.render.getDefaultFont( pixelHeight : integer?, bold : boolean? ) -> LFont  -- Returns a built-in default font at the nearest available pixel height
...
*Coverage: 400/400 items documented (100%)*
...
LGuiTable:clearRows( self : LGuiTable )  -- Clears all rows and the selected row in this table widget
...
LGuiTable:setDataFrame( self : LGuiTable, df : LDataFrame, opts : table? ) -> integer  -- Replaces columns and rows from a dataframe, stringifying cell values for display
LGuiTable:setOnSelect( self : LGuiTable, f : function )  -- Registers a callback invoked when a table row is selected
LGuiTable:setRows( self : LGuiTable, rows : table ) -> integer  -- Replaces all rows with an array of row arrays
...
```lua
LTheme:setStyle( widget_type : string, state : string, style_class : string?, style_table : table )  -- Sets a style entry for the given widget type and state, optionally restricted to a style class
...
LUiWidget:getMouseFilter( self : LUiWidget ) -> string  -- Returns the mouse filter of this widget
...
LUiWidget:getStyleClass( self : LUiWidget ) -> string  -- Returns the style class of this widget
...
LUiWidget:setMouseFilter( self : LUiWidget, filter : string )  -- Sets the mouse filter for this widget ("stop", "pass", "ignore")
...
LUiWidget:setStyleClass( self : LUiWidget, class : string )  -- Sets the style class of this widget
