...
- Full Markdown reference: [docs/api/lurek.md](../blob/main/docs/api/lurek.md) (9587 lines)
- LuaCATS editor stub: [docs/api/lurek.lua](../blob/main/docs/api/lurek.lua) (34862 lines)
