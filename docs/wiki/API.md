...
- Markdown reference: [docs/api/lurek.md](../blob/main/docs/api/lurek.md) (7878 lines)
- LuaCATS stub: [docs/api/lurek.lua](../blob/main/docs/api/lurek.lua) (28259 lines)

## Coverage

- 66 modules
- 5168 functions and methods
- 100.0% documented
...
| [lurek.audio](Module-audio) | 93 | 6 | Sound loading and playback wrapping rodio; Mixer / Bus instances live in SharedState. |
...
| [lurek.dsp](Module-dsp) | 11 | 0 | Digital signal processing: real-time effects chains, offline batch processing, audio visualization. |
