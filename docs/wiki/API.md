...
- LuaCATS stub: [docs/api/lurek.lua](../blob/main/docs/api/lurek.lua) (28252 lines)
...
| [lurek.dsp](Module-dsp) | 5 | 0 | Digital signal processing: real-time effects chains, offline batch processing, audio visualization. |
