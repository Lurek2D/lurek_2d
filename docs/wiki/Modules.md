...
| [data](Module-data) | `lurek.data` | Binary data toolkit: byte buffers, compression, hashing, encoding, structured pack / unpack. |
...
| [graph](Module-graph) | `lurek.graph` | Directed flow-simulation graph: typed items flow through nodes, accumulate, decay, react. |
...
| [serial](Module-serial) | `lurek.serial` | Format-agnostic text serialisation centred on the recursive SerialValue enum. |
