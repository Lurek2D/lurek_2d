...
- `LMCTSEngine` (3 methods) - Lua handle for Monte Carlo tree search over Lua-defined game states and actions.
- `LNeedSystem` (7 methods) - Lua handle for decaying needs and urgency selection.
- `LORCASolver` (8 methods) - Lua handle for reciprocal velocity obstacle avoidance agents.
...
- Lua-visible types: 23
- Total type methods: 237
