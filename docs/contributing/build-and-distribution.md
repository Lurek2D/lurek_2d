# Lurek2D Build and Distribution Guide
...
## Linux Portability & Distribution
...
- Linux is a declared desktop target in `docs/architecture/philosophy.md` and `docs/architecture/engine-core.md`.
...
The current architecture does not prescribe removing core systems to meet a packaging target. Treat the shipped runtime as the supported feature set and improve distribution through build profiles, symbols, artifact layout, and packaging rather than through undocumented feature extraction.
