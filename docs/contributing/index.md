...
| Area | Source | Role |
|---|---|---|
| Architecture | [docs/architecture/](https://github.com/Lurek2D/lurek_2d/tree/main/docs/architecture) | High-level design, constraints, ownership, and lifecycle. |
...
Do not edit generated API, module, spec, or Pages output by hand. Update the owning source:
