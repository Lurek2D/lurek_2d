...
- [ ] **A-04** — Content sync: Files not in Source Files table: effects.rs
...
- [ ] **B-03** — impl LuaUserData placement: impl LuaUserData in lua_api — move to src/image/
- [ ] **R-02** — Dependency direction: image_data: Tier1 imports log_msg(unassigned)
- [ ] **T-04** — Float comparisons: assert_eq! with float literals (use abs()<epsilon): line 133, line 166
...
- [ ] **B-04** — No business logic: Long closures (>15 LOC) — delegate to domain: line 126
...
| **A-03** Purpose quality | ✅ PASS | Purpose section is 493 chars |
| **A-04** Content sync | ❌ ERROR | Files not in Source Files table: effects.rs |
...
| **B-03** impl LuaUserData placement | ❌ ERROR | impl LuaUserData in lua_api — move to src/image/ |
| **B-04** No business logic | ⚠️ WARNING | Long closures (>15 LOC) — delegate to domain: line 126 |
...
| **T-04** Float comparisons | ❌ ERROR | assert_eq! with float literals (use abs()<epsilon): line 133, line 166 |
