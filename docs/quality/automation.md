...
> **Status**: 🔴 FAIL  |  **Date**: 2026-04-09  |  **Score**: 36 ✅ / 2 ⚠️ / 5 ❌ / 21 🔵
...
- [ ] **SP-04** — Lua API completeness: Functions missing from spec: loadFromToml
...
| **SP-04** Lua API completeness | ❌ ERROR | Functions missing from spec: loadFromToml |
