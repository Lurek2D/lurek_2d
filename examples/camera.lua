...
function luna.draw()
    -- luna.graphics.setCamera(camera) would apply the transform for all draws
    -- (actual graphics-integration call depends on luna.graphics API)
    luna.graphics.drawCircle("fill", player.x, player.y, 16)
end
]]
