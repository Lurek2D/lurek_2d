...
- Test edge states explicitly via `tests/lua/unit/test_ai_unit.lua`: idle, chase, lose-target, reset, empty world, conflicting goals, no-valid-action. These are the common failure modes.
