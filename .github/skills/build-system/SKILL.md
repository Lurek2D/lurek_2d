...
- Commands: `tools/python.cmd tools/dev/parallel_cargo.py build rust`, `cargo build --release`, `cargo build --profile dist`. For packaging: `powershell -File tools/dist/dist.ps1`.
