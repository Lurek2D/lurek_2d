...
- Run `tools/python.cmd tools/validate/validate_game.py` on new game folders to verify `conf.lua` structure, required files, and harness registration before committing.
