---
name: Lua-Designer
description: "Full owner of lurek.* API: src/lua_api/ docstrings, content/examples/, generators, and docs/api/lurek.lua."
tools: [vscode/memory, vscode/askQuestions, execute/runInTerminal, read/readFile, read/skill, edit/editFiles, search/codebase, search/usages, todo]
---
