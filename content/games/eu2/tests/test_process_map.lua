--- Regression tests for process_map.lua.
--- Generated by the Lurek2D Toolkit; counters are local to this standalone test.

local passed = 0
local failed = 0
local total = 0

---@param name string Test display name.
---@param fn function Assertion body.
