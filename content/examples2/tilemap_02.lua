...
--@api-stub: lurek.tilemap.toScreenHex / fromScreenHex
...
--@api-stub: lurek.tilemap.toScreenIso / fromScreenIso
...
--@api-stub: lurek.tilemap.isoDirectionFromAngle / isoDirectionName / isoRotate
