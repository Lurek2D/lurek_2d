...
-- ============================================================================
-- Category : retro
-- Source   : content/newgames/turrican/main.lua
-- Run with : cargo run -- content/newgames/turrican
-- ============================================================================
...
local function newgames_ui_node(id)
    if lurek.ui.getElementById then
        local node = newgames_ui_node(id)
        if node then return node end
    end
    return { visible = false, text = "", color = {1, 1, 1, 1}, x = 0, y = 0, setOnClick = function() end }
end
...
function lurek.init()
    ...
    pcall(lurek.ui.loadLayoutFile, "content/newgames/turrican/ui.toml")
...
function lurek.process(dt)
    ...
    -- ── UI Update ─────────────────────────────────────────────
    local title_panel = newgames_ui_node("title_panel")
    local game_over_panel = newgames_ui_node("game_over_panel")
    local lc_panel = newgames_ui_node("level_complete_panel")
    local hud_panel = newgames_ui_node("hud_panel")
