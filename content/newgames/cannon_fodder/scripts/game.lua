...
-- ============================================================================
-- Category : action
-- Source   : content/newgames/cannon_fodder/main.lua
-- Run with : cargo run -- content/newgames/cannon_fodder
-- ============================================================================
...
function lurek.init()
    ...
    pcall(lurek.ui.loadLayoutFile, "content/newgames/cannon_fodder/ui.toml")
