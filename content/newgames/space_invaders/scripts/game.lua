...
-- ============================================================================
-- Category : arcade
-- Source   : content/newgames/space_invaders/main.lua
-- Run with : cargo run -- content/newgames/space_invaders
-- ============================================================================
...
function lurek.init()
    ...
    pcall(lurek.ui.loadLayoutFile, "content/newgames/space_invaders/ui.toml")
