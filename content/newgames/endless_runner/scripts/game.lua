...
-- ----------------------------------------------------------------------------
--  Category : action
--  Run with : cargo run -- content/newgames/endless_runner
--
...
function lurek.init()
    ...
    pcall(lurek.ui.loadLayoutFile, "content/newgames/endless_runner/ui.toml")
    local ui_root = lurek.ui.getRoot()
    app_ui.best_score = ui_root:findById("app_ui.best_score")
    app_ui.coins_val = ui_root:findById("app_ui.coins_val")
    app_ui.dead_panel = ui_root:findById("app_ui.dead_panel")
    app_ui.dist_val = ui_root:findById("app_ui.dist_val")
    app_ui.fps_label = ui_root:findById("app_ui.fps_label")
    app_ui.go_coins = ui_root:findById("app_ui.go_coins")
    app_ui.go_dist = ui_root:findById("app_ui.go_dist")
    app_ui.go_restart = ui_root:findById("app_ui.go_restart")
    app_ui.go_total = ui_root:findById("app_ui.go_total")
    app_ui.high_score_title = ui_root:findById("app_ui.high_score_title")
    app_ui.hud_panel = ui_root:findById("app_ui.hud_panel")
    app_ui.jump_2x = ui_root:findById("app_ui.jump_2x")
    app_ui.score_val = ui_root:findById("app_ui.score_val")
    app_ui.speed_up = ui_root:findById("app_ui.speed_up")
    app_ui.speed_val = ui_root:findById("app_ui.speed_val")
    app_ui.start_label = ui_root:findById("app_ui.start_label")
    app_ui.title_panel = ui_root:findById("app_ui.title_panel")
