...
-- ============================================================================
-- Category : sports
-- Source   : content/newgames/sensible_soccer/main.lua
-- Run with : cargo run -- content/newgames/sensible_soccer
-- ============================================================================
...
function lurek.init()
    ...
    local ok_ui, ui_root = pcall(lurek.ui.loadLayoutFile, "content/newgames/sensible_soccer/ui.toml")
    if not ok_ui or not ui_root then ui_root = { findById = function() return { visible = false, text = "", color = {1, 1, 1, 1}, x = 0, y = 0, setOnClick = function() end } end } end
    app_ui = {}
