...
-- Returns one cell per unique input point; vertices ordered CCW by angle.
-- Convex-hull cells are open (no infinite rays).
...
local cells = lurek.math.voronoi(seed_pts)
for i, cell in ipairs(cells) do
    -- cell.site  = {x, y}
    -- cell.vertices = {{x,y}, …} ordered CCW around cell.site
    print(string.format("Cell %d: site (%.1f, %.1f), %d vertices",
        i, cell.site.x, cell.site.y, #cell.vertices))
end
