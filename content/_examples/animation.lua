...
-- Use this to pass the correct UV region to a sprite drawer.
...
-- ━━ Sprite Pattern (typical lurek.process/lurek.render usage) ━━━━━━━━━━

--[[
function lurek.init()
    -- Assume we have an image and an initialized render module
...
function lurek.process(dt)
    ...
    if lurek.keyboard and lurek.keyboard.isDown("right") then
...
function lurek.render()
    ...
    if q then
        -- drawing integration left out of this example
    end
end
]]
-- examples/animation.lua
