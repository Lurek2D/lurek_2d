...
--@api-stub: lurek.window.setTitle -- Sets the window title bar text
...
--@api-stub: lurek.window.getTitle -- Returns the current window title bar text
...
--@api-stub: lurek.window.getWidth -- Returns the current window width in logical (DPI-independent) pixels
...
--@api-stub: lurek.window.getHeight -- Returns the current window height in logical (DPI-independent) pixels
...
--@api-stub: lurek.window.getDimensions -- Returns the current window width and height in logical pixels
...
--@api-stub: lurek.window.setFullscreen -- Enables or disables fullscreen mode
...
--@api-stub: lurek.window.getFullscreen -- Returns the current fullscreen state and type
...
--@api-stub: lurek.window.isOpen -- Returns whether the window is currently open
...
--@api-stub: lurek.window.setVSync -- Sets the vertical sync mode
do -- lurek.window.setVSync
  local benchmark = false
  lurek.window.setVSync(benchmark and 0 or 1)
end

--@api-stub: lurek.window.getVSync -- Returns the current VSync mode
...
--@api-stub: lurek.window.hasFocus -- Returns whether the window currently has keyboard focus
...
--@api-stub: lurek.window.hasMouseFocus -- Returns whether the mouse cursor is inside the window
...
--@api-stub: lurek.window.isMinimized -- Returns whether the window is currently minimized to the taskbar
...
--@api-stub: lurek.window.isMaximized -- Returns whether the window is currently maximized
...
--@api-stub: lurek.window.isVisible -- Returns whether the window is currently visible on screen
...
--@api-stub: lurek.window.minimize -- Minimizes the window to the taskbar
...
--@api-stub: lurek.window.maximize -- Maximizes the window to fill the screen
...
--@api-stub: lurek.window.restore -- Restores the window from minimized or maximized state to its previous size and position
...
--@api-stub: lurek.window.getPosition -- Returns the window position on screen in pixels
...
--@api-stub: lurek.window.setPosition -- Moves the window to the specified screen position
...
--@api-stub: lurek.window.getDisplayCount -- Returns the number of connected displays (monitors)
...
--@api-stub: lurek.window.getDesktopDimensions -- Returns the desktop resolution of a specific display, or the current display if none is specified
...
--@api-stub: lurek.window.getDPIScale -- Returns the current DPI scale factor of the window
...
--@api-stub: lurek.window.toPixels -- Converts a value from logical (DPI-independent) units to physical pixel units using the current DPI scale
...
--@api-stub: lurek.window.fromPixels -- Converts a value from physical pixel units to logical (DPI-independent) units using the current DPI scale
...
--@api-stub: lurek.window.setIcon -- Sets the window icon from an image file
...
--@api-stub: lurek.window.setMode -- Sets the window display mode with a specific resolution and optional flags
...
--@api-stub: lurek.window.getMode -- Returns the current window display mode: width, height, and a flags table containing fullscreen state, fullscreen type, and VSync mode
...
--@api-stub: lurek.window.windowConfig -- Applies multiple window settings at once from a configuration table
...
--@api-stub: lurek.window.close -- Closes the window and signals the engine to shut down
...
--@api-stub: lurek.window.requestAttention -- Requests user attention by flashing the taskbar icon
...
--@api-stub: lurek.window.getFullscreenModes -- Returns a list of all supported fullscreen video modes across all monitors
...
--@api-stub: lurek.window.getDisplayName -- Returns the human-readable name of a display
do -- lurek.window.getDisplayName
  local name = lurek.window.getDisplayName()
  lurek.log.info("running on display: " .. name, "video")
end

--@api-stub: lurek.window.getPixelDimensions -- Returns the window dimensions in actual physical pixels, accounting for DPI scaling
...
--@api-stub: lurek.window.focus -- Requests keyboard focus for the window
...
--@api-stub: lurek.window.getNativeDPIScale -- Returns the native DPI scale factor reported by the operating system
...
--@api-stub: lurek.window.getDisplayOrientation -- Returns the display orientation based on the window's aspect ratio
do -- lurek.window.getDisplayOrientation
  local orient = lurek.window.getDisplayOrientation()
  lurek.log.info("layout mode: " .. orient, "ui")
end

--@api-stub: lurek.window.getSafeArea -- Returns the safe drawing area of the window
do -- lurek.window.getSafeArea
  local x, y, w, h = lurek.window.getSafeArea()
  lurek.log.info("safe area " .. w .. "x" .. h .. " at (" .. x .. "," .. y .. ")", "ui")
end

--@api-stub: lurek.window.getSystemTheme -- Returns the operating system's current color theme
...
--@api-stub: lurek.window.isHighDPIAllowed -- Returns whether high-DPI rendering is allowed
...
--@api-stub: lurek.window.getScaleInfo -- Returns detailed scaling information including scale factors, offsets, and logical game dimensions
...
--@api-stub: lurek.window.getScaleMode -- Returns the current content scale mode name (e
do -- lurek.window.getScaleMode
  local mode = lurek.window.getScaleMode()
  lurek.log.info("viewport scale mode: " .. mode, "video")
end

--@api-stub: lurek.window.setScaleMode -- Sets the content scale mode
...
--@api-stub: lurek.window.getGameWidth -- Returns the logical game width as defined by the current scale mode and game configuration
...
--@api-stub: lurek.window.getGameHeight -- Returns the logical game height as defined by the current scale mode and game configuration
...
--@api-stub: lurek.window.isFullscreen -- Returns whether the window is currently in fullscreen mode
...
--@api-stub: lurek.window.isResizable -- Returns whether the window can be resized by the user
...
--@api-stub: lurek.window.onDpiChange -- Registers a callback function that is called whenever the DPI scale factor changes (e
...
--@api-stub: lurek.window.pollDpiChange -- Checks if the DPI scale has changed since the last poll and fires the onDpiChange callback if so
...
--@api-stub: lurek.window.openFileDialog -- Opens a native file picker dialog and returns the selected file paths
...
--@api-stub: lurek.window.getDisplays -- Returns a list of all connected displays with their properties
...
--@api-stub: lurek.window.getCurrentDisplay -- Returns the index of the display that currently contains the window
do -- lurek.window.getCurrentDisplay
  local idx = lurek.window.getCurrentDisplay()
  lurek.log.info("current monitor index: " .. idx, "video")
end

--@api-stub: lurek.window.setDisplay -- Moves the window to the specified display
...
--@api-stub: lurek.window.flash -- Flashes the window briefly to attract the user's attention
