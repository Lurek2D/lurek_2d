...
--@api: LAwarenessGrid:getFogIntensity
do
    local vg = lurek.awareness.new({ regions = 300, players = 4 })
    vg:reveal(0, 0)
    vg:hide(0, 0)
...
--@api: LAwarenessGrid:sharesVisibility
do
    local vg = lurek.awareness.new({ regions = 300, players = 4 })
    vg:setGroup({ 1, 2 })
...
--@api: LAwarenessGrid:drainEvents
do
    local vg = lurek.awareness.new({ regions = 100, players = 2 })
    vg:reveal(0, 3, 2)
    local events = vg:drainEvents()
...
--@api: LAwarenessGrid:regionCount
do
    local vg = lurek.awareness.new({ regions = 100, players = 2 })
    local regions = vg:regionCount()
    local players = vg:playerCount()
...
--@api: LAwarenessGrid:playerCount
do
    local vg = lurek.awareness.new({ regions = 100, players = 2 })
    vg:setGroup({ 0, 1 })
    local players = vg:playerCount()
...
--@api: lurek.awareness.lineOfSight
do
...
--@api: lurek.awareness.lineOfAction
do
    local field = lurek.tilefield.new({ width = 6, height = 3 })
    field:applyProfile(3, 2, 1, "window")
    local from = { x = 1, y = 2, z = 1 }
...
--@api: lurek.awareness.newTileAwareness
do
...
--@api: LTileAwareness:computeVisible
do
    local field = lurek.tilefield.new({ width = 6, height = 6 })
...
--@api: LTileAwareness:computeAction
do
    local field = lurek.tilefield.new({ width = 6, height = 3 })
    field:applyProfile(3, 2, 1, "window")
    local vis = lurek.awareness.newTileAwareness(field, { players = { "p1" } })
...
--@api: LTileAwareness:visibleCells
do
    local field = lurek.tilefield.new({ width = 4, height = 4 })
    local vis = lurek.awareness.newTileAwareness(field, { players = { "p1" } })
    vis:computeVisible("p1", { origin = { x = 2, y = 2, z = 1 }, range = 1 })
...
--@api: LTileAwareness:actionCells
do
    local field = lurek.tilefield.new({ width = 4, height = 4 })
    local vis = lurek.awareness.newTileAwareness(field, { players = { "p1" } })
    vis:computeAction("p1", { origin = { x = 2, y = 2, z = 1 }, range = 1 })
...
--@api: LTileAwareness:clearPlayer
do
    local field = lurek.tilefield.new({ width = 4, height = 4 })
    local vis = lurek.awareness.newTileAwareness(field, { players = { "p1" } })
    vis:computeVisible("p1", { origin = { x = 2, y = 2, z = 1 }, range = 1 })
...
--@api: LTileAwareness:updateSightSources
do
