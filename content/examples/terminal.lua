...
do
    ...
    list:addItem("Apple"); list:addItem("Banana"); list:addItem("Cherry")
    list:addItem("Date")
...
do
    ...
    panel:addChild(lurek.terminal.newLabel(2, 4, "Label B")); panel:addChild(lurek.terminal.newButton(2, 6, 10, 1, "Btn"))
