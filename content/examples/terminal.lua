...
do
    ...
    lurek.log.info("newTerminal grid=" .. cols .. "x" .. rows .. " cell=" .. cell_w .. "x" .. cell_h .. " prompt=" .. prompt_char)
end

--@api: LTerminal:set
do

    local term = lurek.terminal.newTerminal(32, 8)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    ...
    lurek.log.info("set alert glyph=" .. glyph .. " fg=" .. fr .. "," .. fg .. "," .. fb)
end
...
do
    ...
    lurek.log.info("trySet success=" .. tostring(ok) .. " err=" .. tostring(err))
    lurek.log.info("trySet invalid=" .. tostring(bad_ok) .. " reason=" .. tostring(bad_err))
end
...
do
    ...
    lurek.log.info("get status pair=" .. pair)
end
...
do
    ...
    lurek.log.info("print wrote line prefix=" .. first .. second)
end
...
do
    ...
    lurek.log.info("clear reset row6 from " .. before .. " to " .. after)
end

--@api: LTerminal:getCellSize
do

    local term = lurek.terminal.newTerminal(30, 8)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    ...
    local cols, rows = term:getDimensions()
    lurek.log.info("getCellSize override=" .. w .. "x" .. h .. " for grid=" .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.log.info("setCellSize changed " .. before_w .. "x" .. before_h .. " to " .. after_w .. "x" .. after_h)
end
...
do
    ...
    local w, h = term:getCellSize()
    local cols, rows = term:getDimensions()
    lurek.log.info("resetCellSize restored cell=" .. w .. "x" .. h .. " for " .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.log.info("setFont 16px=" .. large_w .. "x" .. large_h .. " 12px=" .. small_w .. "x" .. small_h)
end
...
do
    ...
    term:render()
    local cols, rows = term:getDimensions()
    lurek.log.info("render submitted terminal at " .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.log.info("renderImage produced " .. width .. "x" .. height .. " image")
end
...
do
    ...
    lurek.log.info("render stats cells=" .. tostring(stats.cells_composed))
    lurek.log.info("render stats widgets=" .. tostring(stats.widgets_drawn))
    lurek.log.info("render stats list_items=" .. tostring(stats.list_items_drawn))
end

--@api: LTerminal:autoResize
do

    local term = lurek.terminal.newTerminal(50, 18)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    ...
    local cols, rows = term:getDimensions()
    local w, h = term:getCellSize()
    lurek.log.info("autoResize fit window for " .. cols .. "x" .. rows .. " using " .. w .. "x" .. h .. " cells")
end
...
do
    ...
    lurek.log.info("newLabel type=" .. kind .. " text='" .. text .. "' at " .. col .. "," .. row)
end
...
do
    ...
    lurek.log.info("newButton '" .. text .. "' size=" .. width .. "x" .. height .. " enabled=" .. tostring(enabled))
end
...
do
    ...
    lurek.log.info("newTextBox text='" .. text .. "' max=" .. max_length)
end
...
do
    ...
    lurek.log.info("trySetText ok=" .. tostring(ok) .. " err=" .. tostring(err))
    lurek.log.info("trySetText value='" .. tostring(input:getText()) .. "'")
    lurek.log.info("trySetText max=" .. tostring(input:getMaxLength()))
end
...
do
    ...
    lurek.log.info("newList items=" .. count .. " first=" .. first .. " selected=" .. selected)
end
...
do
    ...
    lurek.log.info("newBorder style=" .. style .. " title='" .. title .. "'")
end
...
do
    ...
    lurek.log.info("newPanel children=" .. children .. " header='" .. header .. "' state='" .. state .. "'")
end

--@api: LTerminal:addWidget
do

    local term = lurek.terminal.newTerminal(48, 16)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    ...
    lurek.log.info("addWidget count=" .. term:getWidgetCount())
end
...
do
    ...
    lurek.log.info("removeWidget remaining=" .. term:getWidgetCount())
end
...
do
    ...
    lurek.log.info("getWidgetCount total=" .. count)
end
...
do
    ...
    term:clearWidgets()
    local count = term:getWidgetCount()
    lurek.log.info("clearWidgets remaining=" .. count)
end
...
do
    ...
    lurek.log.info("setFocus route_box=" .. tostring(term:getFocused() == route_box))
end
...
do
    ...
    lurek.log.info("getFocused type=" .. focused_type)
end
...
do
    ...
    lurek.log.info("keypressed handled=" .. tostring(handled) .. " text='" .. input:getText() .. "'")
end
...
do
    ...
    lurek.log.info("textinput handled=" .. tostring(handled) .. " text='" .. input:getText() .. "'")
end
...
do
    ...
    lurek.log.info("diagnostics oob=" .. tostring(diagnostics.out_of_bounds_writes))
    lurek.log.info("diagnostics clipped=" .. tostring(diagnostics.clipped_text))
end
...
do
    ...
    lurek.log.info("clearDiagnostics before=" .. tostring(before.out_of_bounds_writes))
    lurek.log.info("clearDiagnostics after=" .. tostring(after.out_of_bounds_writes))
end
...
do
    ...
    lurek.log.info("validateWidgets valid=" .. tostring(valid))
    lurek.log.info("validateWidgets errors=" .. tostring(errors and #errors or 0))
end
...
do
    ...
    term:addWidget(button)
    local cell_w, cell_h = term:getCellSize()
    term:mousepressed((2 - 1) * cell_w + 1, (4 - 1) * cell_h + 1, 1)
    local focused = term:getFocused()
    lurek.log.info("mousepressed focused_button=" .. tostring(focused == button))
end
...
do
    ...
    local cols, rows = term:getDimensions()
    lurek.log.info("applyTheme cycled " .. #themes .. " themes on " .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.log.info("pushCmdHistory last='" .. tostring(previous) .. "' len=" .. lurek.terminal.cmdHistoryLen(term))
end
...
do
    ...
    lurek.log.info("tryPushCmdHistory ok=" .. tostring(ok) .. " err=" .. tostring(err))
    lurek.log.info("tryPushCmdHistory len=" .. tostring(lurek.terminal.cmdHistoryLen(term)))
end
...
do
    ...
    lurek.log.info("cmdHistoryLen count=" .. count)
end
...
do
    ...
    lurek.log.info("pushScrollback first='" .. tostring(lines[1]) .. "' count=" .. #lines)
end
...
do
    ...
    lurek.log.info("tryPushScrollback ok=" .. tostring(ok) .. " err=" .. tostring(err))
    lurek.log.info("tryPushScrollback len=" .. tostring(lurek.terminal.scrollbackLen(term)))
    lurek.log.info("tryPushScrollback latest='" .. tostring(lurek.terminal.getScrollback(term, 0, 1)[1]) .. "'")
end
...
do
    ...
    lurek.log.info("setScrollbackCap kept=" .. lurek.terminal.scrollbackLen(term) .. " line(s)")
end
...
do
    ...
    lurek.log.info("addCompletion matches=" .. #matches .. " first='" .. tostring(next_value) .. "'")
end
...
do
    ...
    lurek.log.info("nextCompletion cycled '" .. tostring(first) .. "' then '" .. tostring(second) .. "'")
end
...
do
    ...
    lurek.log.info("parseAnsi span_count=" .. #spans .. " parts=" .. summary)
end
...
do
    ...
    local term = lurek.terminal.newTerminal(36, 8)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    term:print(1, 4, stripped)
    lurek.log.info("stripAnsi plain='" .. stripped .. "'")
end
...
do
    ...
    lurek.log.info("printAnsi row5 prefix=" .. first .. second)
end
...
do
    ...
    lurek.log.info("printHighlighted row6 prefix=" .. first .. fifth)
end
...
do
    ...
    lurek.log.info("getMaxCols max=" .. max_cols .. " active=" .. cols .. "x" .. rows)
end
...
do
    ...
    local text = label:getText()
    lurek.log.info("LLabel:setColor text='" .. text .. "' rgba=" .. r .. "," .. g .. "," .. b .. "," .. a)
end
...
do
    ...
    lurek.log.info("LButton:isEnabled before=" .. tostring(before) .. " after=" .. tostring(after))
end
...
do
    ...
    lurek.log.info("LList:addItem count=" .. count .. " last='" .. tostring(last) .. "'")
end
...
do
    ...
    lurek.log.info("LPanel:addChild children=" .. panel:getChildCount())
end

--@api: LTerminal:getDimensions
do

    local term = lurek.terminal.newTerminal(54, 18)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    local cols, rows = term:getDimensions()
    ...
    lurek.log.info("getDimensions grid=" .. cols .. "x" .. rows .. " cell=" .. cell_w .. "x" .. cell_h)
end

--@api: LTerminal:type
do

    local term = lurek.terminal.newTerminal(24, 6)
    lurek.terminal.applyTheme(term, "nord")
    term:print(1, 1, "> status")
    term:print(1, 2, "bridge online")
    ...
    lurek.log.info("type kind=" .. kind .. " grid=" .. cols .. "x" .. rows)
end
...
do
    ...
    local cols, rows = term:getDimensions()
    lurek.log.info("typeOf LTerminal=" .. tostring(is_terminal) .. " LObject=" .. tostring(is_object) .. " grid=" .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.terminal.clearCmdHistory(term)
    local count = lurek.terminal.cmdHistoryLen(term)
    lurek.log.info("clearCmdHistory count=" .. count)
end
...
do
    ...
    lurek.terminal.pushCmdHistory(term, "dock")
    local previous = lurek.terminal.prevCmd(term)
    lurek.log.info("prevCmd value='" .. tostring(previous) .. "'")
end
...
do
    ...
    lurek.log.info("nextCmd value='" .. tostring(lurek.terminal.nextCmd(term)) .. "'")
end
...
do
    ...
    lurek.log.info("getScrollback first='" .. tostring(lines[1]) .. "' second='" .. tostring(lines[2]) .. "'")
end
...
do
    ...
    lurek.log.info("scrollbackLen count=" .. count)
end
...
do
    ...
    lurek.log.info("removeCompletion matches=" .. #matches .. " survivor='" .. tostring(matches[1]) .. "'")
end
...
do
    ...
    lurek.log.info("resetCompletion restart='" .. tostring(lurek.terminal.nextCompletion("sc")) .. "' first='" .. tostring(first) .. "'")
end
...
do
    ...
    lurek.log.info("clearCompletions matches=" .. #matches)
end
...
do
    ...
    lurek.terminal.addCompletion("status")
    local matches = lurek.terminal.getCompletions("sc")
    lurek.log.info("getCompletions count=" .. #matches .. " second='" .. tostring(matches[2]) .. "'")
end
...
do
    ...
    lurek.log.info("getMaxRows max=" .. max_rows .. " active=" .. cols .. "x" .. rows)
end
...
do
    ...
    lurek.log.info("getChild count=" .. count .. " first='" .. text .. "' seed='" .. title:getText() .. "'")
end
...
do
    ...
    lurek.log.info("getChildCount count=" .. count .. " values='" .. first .. "'/'" .. second .. "'")
end
...
do
    ...
    panel:addChild(title)
    panel:addChild(value)
    lurek.log.info("addChild children=" .. panel:getChildCount())
end
...
do
    ...
    panel:clearChildren()
    local count = panel:getChildCount()
    lurek.log.info("clearChildren count=" .. count)
end
...
do
    ...
    lurek.log.info("removeChild remaining=" .. panel:getChildCount())
end
...
do
    ...
    local count = list:getItemCount()
    lurek.log.info("addItem count=" .. count .. " last='" .. tostring(list:getItem(3)) .. "'")
end
...
do
    ...
    lurek.log.info("clearItems before=" .. before .. " after=" .. after)
end
...
do
    ...
    lurek.log.info("getItem first='" .. tostring(first) .. "' second='" .. tostring(second) .. "'")
end
...
do
    ...
    local count = list:getItemCount()
    local selected = list:getSelected()
    lurek.log.info("getItemCount count=" .. count .. " selected=" .. tostring(selected))
end
...
do
    ...
    local r, g, b, a = label:getColor()
    local text = label:getText()
    lurek.log.info("getColor text='" .. text .. "' rgba=" .. r .. "," .. g .. "," .. b .. "," .. a)
end
...
do
    ...
    local style = border:getStyle()
    lurek.log.info("getStyle style='" .. style .. "' title='" .. border:getTitle() .. "'")
end
...
do
    ...
    local text = label:getText()
    lurek.log.info("getTag tag='" .. tag .. "' text='" .. text .. "'")
end
...
do
    ...
    lurek.log.info("getText text='" .. text .. "' size=" .. width .. "x" .. height)
end
...
do
    ...
    local title = border:getTitle()
    local style = border:getStyle()
    lurek.log.info("getTitle title='" .. title .. "' style='" .. style .. "'")
end
...
do
    ...
    lurek.log.info("getMaxLength max=" .. max_length .. " text='" .. box:getText() .. "'")
end
...
do
    ...
    local count = list:getItemCount()
    lurek.log.info("getPosition pos=" .. col .. "," .. row .. " size=" .. width .. "x" .. height .. " items=" .. count)
end
...
do
    ...
    local col, row = list:getPosition()
    local count = list:getItemCount()
    lurek.log.info("getSize size=" .. width .. "x" .. height .. " at " .. col .. "," .. row .. " items=" .. count)
end
...
do
    ...
    lurek.log.info("getSelected index=" .. tostring(selected) .. " item='" .. tostring(item) .. "'")
end
...
do
    ...
    button:setEnabled(false)
    local after = button:isEnabled()
    lurek.log.info("isEnabled before=" .. tostring(before) .. " after=" .. tostring(after))
end
...
do
    ...
    lurek.log.info("isVisible before=" .. tostring(before) .. " after=" .. tostring(after))
end
...
do
    ...
    local text = button:getText()
    local width, height = button:getSize()
    lurek.log.info("widget type kind=" .. kind .. " text='" .. text .. "' size=" .. width .. "x" .. height)
end
...
do
    ...
    local text = button:getText()
    lurek.log.info("widget typeOf text='" .. text .. "' LWidget=" .. tostring(is_widget) .. " LObject=" .. tostring(is_object))
end
...
do
    ...
    local r, g, b, a = label:getColor()
    local text = label:getText()
    lurek.log.info("setColor text='" .. text .. "' rgba=" .. r .. "," .. g .. "," .. b .. "," .. a)
end
...
do
    ...
    lurek.log.info("setEnabled restored=" .. tostring(label:isEnabled()) .. " initial_after_disable=" .. tostring(enabled))
end
...
do
    ...
    lurek.log.info("setVisible hidden_state=" .. tostring(hidden) .. " restored=" .. tostring(label:isVisible()))
end
...
do
    ...
    local max_length = box:getMaxLength()
    lurek.log.info("setMaxLength max=" .. max_length .. " text='" .. box:getText() .. "'")
end
...
do
    ...
    local width, height = box:getSize()
    lurek.log.info("setPosition pos=" .. col .. "," .. row .. " size=" .. width .. "x" .. height)
end
...
do
    ...
    local width, height = box:getSize()
    local text = box:getText()
    lurek.log.info("setSize size=" .. width .. "x" .. height .. " text='" .. text .. "'")
end
...
do
    ...
    border:setTitle("Map")
    local style = border:getStyle()
    lurek.log.info("setStyle style='" .. style .. "' title='" .. border:getTitle() .. "'")
end
...
do
    ...
    lurek.log.info("setTag tag='" .. tag .. "' title='" .. border:getTitle() .. "'")
end
...
do
    ...
    local text = button:getText()
    local width, height = button:getSize()
    lurek.log.info("setText text='" .. text .. "' size=" .. width .. "x" .. height)
end
...
do
    ...
    local title = border:getTitle()
    local style = border:getStyle()
    lurek.log.info("setTitle title='" .. title .. "' style='" .. style .. "'")
end
...
do
    ...
    local selected = list:getSelected()
    local item = list:getItem(selected)
    lurek.log.info("setSelected index=" .. tostring(selected) .. " item='" .. tostring(item) .. "'")
end
...
do
    ...
    term:setFocus(input)
    input:setText("dock")
    lurek.log.info("setOnChange changes=" .. changes .. " text='" .. input:getText() .. "'")
end
...
do
    ...
    local cell_w, cell_h = term:getCellSize()
    term:mousepressed((2 - 1) * cell_w + 1, (4 - 1) * cell_h + 1, 1)
    lurek.log.info("setOnClick clicks=" .. clicks .. " text='" .. button:getText() .. "'")
end
...
do
    ...
    lurek.log.info("setOnSelect callbacks=" .. selections .. " item='" .. tostring(item) .. "'")
end
...
do
    ...
    local after = list:getItemCount()
    local first = list:getItem(1)
    lurek.log.info("removeItem before=" .. before .. " after=" .. after .. " first='" .. tostring(first) .. "'")
end
