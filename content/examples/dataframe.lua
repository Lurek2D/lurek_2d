...
--@api-stub: lurek.dataframe.newDataFrame -- Creates an empty dataframe
...
--@api-stub: lurek.dataframe.newDatabase -- Creates an empty dataframe database
...
--@api-stub: lurek.dataframe.fromTable -- Creates a dataframe from an array table of row tables
...
--@api-stub: lurek.dataframe.fromRows -- Creates a dataframe from column names and array-style rows
...
--@api-stub: lurek.dataframe.fromCSV -- Parses a dataframe from CSV text
...
--@api-stub: lurek.dataframe.fromJSON -- Parses a dataframe from JSON text
...
--@api-stub: lurek.dataframe.fromBinary -- Parses a dataframe from binary data
...
--@api-stub: lurek.dataframe.random -- Creates a random dataframe from column definitions
...
--@api-stub: lurek.dataframe.toVec -- Converts a dataframe to a vectorized frame
...
--@api-stub: lurek.dataframe.fromVec -- Converts a vectorized frame to a dataframe
...
--@api-stub: LDataFrame:lazy -- Starts a lazy query pipeline from this dataframe
do -- LDataFrame:lazy
  local df = lurek.dataframe.fromTable({
