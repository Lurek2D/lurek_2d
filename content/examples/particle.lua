...
do
  ...
  local fire = lurek.particle.newSystem({
    ...
    spread = 0.3,          -- cone half-angle in radians (~17 degrees)
  })
...
do
  ...
  -- Create a ground body for particles to collide with
  local ground = lurek.physics.newBody(world, 400, 580, "static")
  lurek.physics.newRectangleShape(ground, 800, 20)
