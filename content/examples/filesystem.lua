...
--@api-stub: lurek.filesystem.mountZip -- Opens a ZIP archive and exposes it through a virtual prefix
...
--@api-stub: lurek.filesystem.watchPath -- Adds a path to the module-local file watcher
...
--@api-stub: lurek.filesystem.unwatchPath -- Removes a path from the module-local file watcher
do -- lurek.filesystem.unwatchPath
  lurek.filesystem.watchPath("assets/levels/forest.json")
  lurek.filesystem.unwatchPath("assets/levels/forest.json")
end

--@api-stub: lurek.filesystem.pollWatchers -- Polls watched paths and returns paths that changed since the previous poll
...
--@api-stub: lurek.filesystem.read -- Reads a UTF-8 text file from GameFS
...
--@api-stub: lurek.filesystem.write -- Writes a UTF-8 text file through GameFS
do -- lurek.filesystem.write
  local score = 12450
  lurek.filesystem.write("save/highscore.txt", tostring(score))
end

--@api-stub: lurek.filesystem.writeJson -- Writes JSON text through GameFS
do -- lurek.filesystem.writeJson
  lurek.filesystem.writeJson("save/profile.json", '{"name":"hero","level":3}')
end

--@api-stub: lurek.filesystem.readJson -- Reads a JSON document as text from GameFS
...
--@api-stub: lurek.filesystem.readOrWriteJson -- Reads a JSON file or writes and returns default JSON when the file is absent
...
--@api-stub: lurek.filesystem.exists -- Returns whether a path exists in GameFS
...
--@api-stub: lurek.filesystem.append -- Appends UTF-8 text to a GameFS file
...
--@api-stub: lurek.filesystem.openFile -- Opens a GameFS file handle in a requested mode
...
--@api-stub: lurek.filesystem.getDirectoryItems -- Lists immediate entries in a GameFS directory
...
--@api-stub: lurek.filesystem.isFile -- Returns whether a GameFS path is a regular file
...
--@api-stub: lurek.filesystem.isDirectory -- Returns whether a GameFS path is a directory
...
--@api-stub: lurek.filesystem.createDirectory -- Creates a GameFS directory and any missing parents
...
--@api-stub: lurek.filesystem.remove -- Removes a GameFS file or supported path
...
--@api-stub: lurek.filesystem.getInfo -- Returns file metadata for a GameFS path when available
...
--@api-stub: lurek.filesystem.getSource -- Returns the GameFS source root string
do -- lurek.filesystem.getSource
  local src = lurek.filesystem.getSource()
  lurek.log.info("game source dir: " .. src, "fs")
end

--@api-stub: lurek.filesystem.getSaveDirectory -- Returns the save directory path used by GameFS
...
--@api-stub: lurek.filesystem.getWorkingDirectory -- Returns the process working directory
...
--@api-stub: lurek.filesystem.getUserDirectory -- Returns the current user's directory path
do -- lurek.filesystem.getUserDirectory
  local home = lurek.filesystem.getUserDirectory()
  lurek.log.info("user home: " .. home, "fs")
end

--@api-stub: lurek.filesystem.getIdentity -- Returns the current filesystem identity string
do -- lurek.filesystem.getIdentity
  local id = lurek.filesystem.getIdentity()
  lurek.log.info("save identity: " .. id, "save")
end

--@api-stub: lurek.filesystem.setIdentity -- Sets the filesystem identity string used by save paths
...
--@api-stub: lurek.filesystem.lines -- Creates an iterator function over lines in a text file
...
--@api-stub: lurek.filesystem.readAsync -- Starts an asynchronous file load request
...
--@api-stub: lurek.filesystem.pollAsync -- Polls an asynchronous file load request
...
--@api-stub: lurek.filesystem.writeAsync -- Starts an asynchronous file write request
...
--@api-stub: lurek.filesystem.pollAsyncWrite -- Polls an asynchronous file write request
...
--@api-stub: lurek.filesystem.copy -- Copies one GameFS file to another path
do -- lurek.filesystem.copy
  lurek.filesystem.copy("save/slot1.dat", "save/slot1.bak")
  lurek.log.info("backed up slot 1", "save")
end

--@api-stub: lurek.filesystem.move -- Moves or renames one GameFS file to another path
...
--@api-stub: lurek.filesystem.removeDir -- Removes a GameFS directory
...
--@api-stub: lurek.filesystem.glob -- Returns GameFS paths matching a glob pattern
...
--@api-stub: lurek.filesystem.listRecursive -- Lists all paths under a GameFS directory recursively
...
--@api-stub: lurek.filesystem.stat -- Returns size and file/directory flags for a GameFS path
...
--@api-stub: lurek.filesystem.createTempFile -- Creates a temporary file through GameFS
...
--@api-stub: lurek.filesystem.mkdir -- Creates a directory under the GameFS base directory
...
--@api-stub: lurek.filesystem.toAbsolutePath -- Resolves a GameFS-relative path against the filesystem base directory
...
--@api-stub: LFileData:getSize -- Returns the byte length of this file data
...
--@api-stub: LFileData:getString -- Returns file data bytes as a Lua string without UTF-8 validation
...
--@api-stub: LFileData:getFilename -- Returns the path associated with this file data object
...
--@api-stub: LFileData:type -- Returns the Lua-visible type name for this file data handle
do -- LFileData:type
...
--@api-stub: LFileData:typeOf -- Returns whether this file data handle matches a supported type name
do -- LFileData:typeOf
...
--@api-stub: LFileHandle:read -- Reads up to an optional byte count and returns text using lossless UTF-8 replacement
do -- LFileHandle:read
...
--@api-stub: LFileHandle:readLine -- Reads the next line from this file handle
...
--@api-stub: LFileHandle:write -- Writes a string to this file handle
...
--@api-stub: LFileHandle:seek -- Moves the file cursor to an absolute byte position
do -- LFileHandle:seek
  local fh = lurek.filesystem.openFile("save/slot1.dat", "r")
  fh:seek(16)
...
--@api-stub: LFileHandle:tell -- Returns the current file cursor position
do -- LFileHandle:tell
  pcall(function()
...
--@api-stub: LFileHandle:getSize -- Returns the size of the open file
...
--@api-stub: LFileHandle:getMode -- Returns the mode used to open this file handle
...
--@api-stub: LFileHandle:flush -- Flushes pending writes on this file handle
...
--@api-stub: LFileHandle:close -- Closes this file handle
...
--@api-stub: LFileHandle:isEOF -- Returns whether the file cursor is at end of file
...
--@api-stub: LFileHandle:type -- Returns the Lua-visible type name for this file handle
do -- LFileHandle:type
...
--@api-stub: LFileHandle:typeOf -- Returns whether this file handle matches a supported type name
...
--@api-stub: LZipMount:readFile -- Reads a file from the ZIP mount by virtual path
...
--@api-stub: LZipMount:contains -- Returns whether a virtual path exists in the ZIP mount
...
--@api-stub: LZipMount:listFiles -- Returns every virtual file path in the ZIP mount
...
--@api-stub: LZipMount:prefix -- Returns the virtual prefix used by this ZIP mount
do -- LZipMount:prefix
  pcall(function()
    local pack = lurek.filesystem.mountZip("dlc/forest_pack.zip", "mods/forest")
...
--@api-stub: LZipMount:type -- Returns the Lua-visible type name for this ZIP mount handle
do -- LZipMount:type
...
--@api-stub: LZipMount:typeOf -- Returns whether this ZIP mount handle matches a supported type name
do -- LZipMount:typeOf
...
--@api-stub: lurek.filesystem.readBytes -- Reads a binary file from GameFS and returns the bytes as a Lua string
...
--@api-stub: lurek.filesystem.writeBytes -- Writes binary data through GameFS
