...
--@api-stub: LOverlay:setFogDensity.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setHeatHazeIntensity.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setVignetteStrength.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setFilmGrainIntensity.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setCloudCount.2
do
    local ov = lurek.effect.newOverlay(800, 600)
    ov:setCloudCount(3)
...
--@api-stub: LOverlay:setCloudSpeed.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setCloudScale.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setCloudOpacity.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setWeather.2
do
    local ov = lurek.effect.newOverlay(800, 600)
    ov:setWeather("snow")
    print("weather = " .. ov:getWeather())
...
--@api-stub: LOverlay:setWeatherIntensity.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setWindDirection.2
do
    local ov = lurek.effect.newOverlay(800, 600)
...
--@api-stub: LOverlay:setWindSpeed.2
do
    local ov = lurek.effect.newOverlay(800, 600)
    ov:setWindSpeed(1.0)
...
--@api-stub: LTransition:isActive
do
    local tr = lurek.effect.newTransition("fade", 1.0)
    print("before play active = " .. tostring(tr:isActive()))
end

--@api-stub: LTransition:update.3
do
    local tr = lurek.effect.newTransition("fade", 0.5)
    tr:play()
    tr:update(1.0)
...
--@api-stub: LTransition:kind
do
    local tr = lurek.effect.newTransition("wipe", 1.0)
    print("kind = " .. tr:kind())
end

--@api-stub: LTransition:color
do
    local tr = lurek.effect.newTransition("fade", 1.0, {0, 0, 0, 1})
...
--@api-stub: LTransition:type
do
    local tr = lurek.effect.newTransition()
    print("type = " .. tr:type())
end

--@api-stub: LTransition:typeOf
do
    local tr = lurek.effect.newTransition()
...
--@api-stub: LOverlay:setCustomShader.2
do
    local ov = lurek.effect.newOverlay(800, 600)
    ov:setCustomShader("chromatic")
