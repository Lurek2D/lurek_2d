...
- Freshness check: before generating new opportunities, run `python tools/audit/test_coverage.py` and `python tools/audit/doc_coverage.py`. These produce the most up-to-date gap data.
