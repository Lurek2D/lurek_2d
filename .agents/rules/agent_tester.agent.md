...
description: "Lurek2D Agent Definition for tester.agent.md"
---

# Lurek2D Agent Definition (Auto-generated)

> [!IMPORTANT]
> DO NOT edit this file directly. This file is auto-generated and kept in sync with
> `.github/agents/tester.agent.md` by running `python tools/github/sync_agent_rules.py`.
> To update these rules, edit the source file and run the sync script.
