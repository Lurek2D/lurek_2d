...
- Arity rule: prefer fixed-arity functions or option tables. Avoid optional positional arguments beyond 2 — they break autocomplete and make `lurek.*` calls hard to read six months later.
