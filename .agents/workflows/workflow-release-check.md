...
## Steps
1. Load [skill: quality-pipeline](../rules/skill_quality-pipeline.md), [skill: build-system](../rules/skill_build-system.md), [skill: tools-cag-validation](../rules/skill_tools-cag-validation.md), and [skill: testing-rust](../rules/skill_testing-rust.md) before acting.
