...
## Steps
1. Load [skill: module-architecture](../rules/skill_module-architecture.md), [skill: documentation](../rules/skill_documentation.md), [skill: testing-rust](../rules/skill_testing-rust.md), and [skill: roadmap-planning](../rules/skill_roadmap-planning.md) before acting.
