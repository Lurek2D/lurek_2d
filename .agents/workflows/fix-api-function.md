...
## Steps
1. Load [skill: dev-debugging](../rules/skill_dev-debugging.md), [skill: lua-api-design](../rules/skill_lua-api-design.md), [skill: rust-coding](../rules/skill_rust-coding.md), and [skill: lua-rust-bridge](../rules/skill_lua-rust-bridge.md) before acting.
