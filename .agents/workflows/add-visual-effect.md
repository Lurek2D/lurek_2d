...
## Steps
1. Load [skill: visual-effects](../rules/skill_visual-effects.md), [skill: gpu-programming](../rules/skill_gpu-programming.md), and [skill: testing-rust](../rules/skill_testing-rust.md) before acting.
