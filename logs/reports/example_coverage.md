...
| `raycaster` | `lurek.raycaster` | `raycaster.lua` | 61 | 0 | 61 | 617 | 235 | 61 |
| `render` | `lurek.render` | `render.lua` | 197 | 0 | 197 | 1843 | 640 | 197 |
...
| `timer` | `lurek.timer` | `timer.lua` | 49 | 0 | 49 | 566 | 185 | 49 |
| `tween` | `lurek.tween` | `tween.lua` | 58 | 0 | 58 | 612 | 196 | 58 |
| `ui` | `lurek.ui` | `ui.lua` | 23 | 0 | 23 | 3415 | 1242 | 23 |
| `window` | `lurek.window` | `window.lua` | 50 | 0 | 50 | 492 | 160 | 50 |
| **TOTAL** | | | **4022** | **0** | **4022** | **48126** | **15982** | **4022** |
