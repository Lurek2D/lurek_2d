...
//!
//! - Data type: `Color`.
//! - Functions: `hsv_to_rgb`, `gamma_to_linear`, `linear_to_gamma`, `hsl_to_rgb`.
...
impl Color {
    ...
    /// Construct an opaque Color from HSL values (hue 0–360, saturation 0–1, lightness 0–1).
    pub fn from_hsl(h: f32, s: f32, l: f32) -> Self {
        hsl_to_rgb(h, s, l)
    }

    /// Construct an opaque Color from HSV values (hue 0–360, saturation 0–1, value 0–1).
    ...
    /// Return a hex string representation (`#RRGGBB` or `#RRGGBBAA` if alpha < 1).
