...
pub fn register(lua: &Lua, lurek: &LuaTable, _state: Rc<RefCell<SharedState>>) -> LuaResult<()> {
    ...
    dt.set(
        ...
        lua.create_function(move |lua, ()| {
            ...
            let tbl = lua.create_table()?;
            /// The 'fps' field value exposed to Lua scripts.
            tbl.set("fps", snap.fps)?;
            /// The 'dt' field value exposed to Lua scripts.
            tbl.set("dt", snap.dt)?;
            /// The 'avg' field value exposed to Lua scripts.
            tbl.set("avg", snap.avg)?;
            /// The 'min' field value exposed to Lua scripts.
            tbl.set("min", snap.min)?;
            /// The 'max' field value exposed to Lua scripts.
            tbl.set("max", snap.max)?;
            /// The 'p50' field value exposed to Lua scripts.
            tbl.set("p50", snap.p50)?;
            /// The 'p95' field value exposed to Lua scripts.
            tbl.set("p95", snap.p95)?;
            /// The 'p99' field value exposed to Lua scripts.
