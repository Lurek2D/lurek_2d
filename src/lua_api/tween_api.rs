...
pub struct LuaSpring {
    /// Reference to the tween system.
    pub system: SpringSystem,
    /// Lua registry key for the target table.
    pub target_table_key: Option<LuaRegistryKey>,
    /// Lua registry key for the on-settle callback.
    pub on_settle_key: Option<LuaRegistryKey>,
    /// Field names to animate on the target table.
