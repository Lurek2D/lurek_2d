...
//! Provides buttons, labels, sliders, text inputs, checkboxes, panels, and more.
...
fn create_widget_table<'a>(
    ...
    t.set("typeOf", lua.create_function(move |_, name: String| {
    ...
    t.set("getRect", lua.create_function(move |_, ()| {
    ...
    t.set("addChild", lua.create_function(move |_, child: LuaValue| {
    ...
    t.set("removeChild", lua.create_function(move |_, child: LuaValue| {
    ...
    t.set("getChildren", lua.create_function(move |lua, ()| {
    ...
    t.set("setOnDraw", lua.create_function(move |lua, (_self, f): (LuaValue, LuaFunction)| {
    ...
    t.set("bind", lua.create_function(move |_, key: String| {
    ...
    t.set("unbind", lua.create_function(move |_, ()| {
    ...
    t.set("setAlpha", lua.create_function(move |_, alpha: f32| {
    ...
    t.set("getAlpha", lua.create_function(move |_, ()| {
    ...
    t.set("fadeIn", lua.create_function(move |_, ()| {
    ...
    t.set("fadeOut", lua.create_function(move |_, ()| {
    ...
    t.set("slideIn", lua.create_function(move |_, (x, y): (f32, f32)| {
    ...
    t.set("slideOut", lua.create_function(move |_, (x, y): (f32, f32)| {
    ...
    t.set("attachToEntity", lua.create_function(move |_, entity_id: u64| {
    ...
    t.set("detachFromEntity", lua.create_function(move |_, ()| {
...
fn add_spin_box_methods(
    ...
    t.set("increment", lua.create_function(move |_, ()| {
    ...
    t.set("decrement", lua.create_function(move |_, ()| {
...
fn add_switch_methods(
    ...
    t.set("setOn", lua.create_function(move |_, on: bool| {
    ...
    t.set("isOn", lua.create_function(move |_, ()| {
    ...
    t.set("toggle", lua.create_function(move |_, ()| {
...
fn add_badge_methods(
    ...
    t.set("setCount", lua.create_function(move |_, count: u32| {
    ...
    t.set("getCount", lua.create_function(move |_, ()| {
    ...
    t.set("getDisplayText", lua.create_function(move |_, ()| {
...
fn add_toolbar_methods(
    ...
    t.set("addSeparator", lua.create_function(move |_, ()| {
    ...
    t.set("addSpacer", lua.create_function(move |_, _size: Option<f32>| {
...
fn add_status_bar_methods(
    ...
    t.set("setSectionCount", lua.create_function(move |_, count: usize| {
    ...
    t.set("setSectionWidget", lua.create_function(move |_, (_section_idx, _widget): (usize, LuaValue)| {
...
pub fn register(lua: &Lua, luna: &LuaTable, state: Rc<RefCell<SharedState>>) -> LuaResult<()> {
    ...
    tbl.set("newToast", lua.create_function(
    ...
    tbl.set("newRadioButton", lua.create_function(
    ...
    tbl.set("getTheme", lua.create_function(move |_, ()| Ok(c.borrow().theme.is_some()))?,
    ...
    tbl.set("getFocus", lua.create_function(move |_, ()| Ok(c.borrow().focused_widget))?,
    ...
    tbl.set("getToastCount", lua.create_function(move |_, ()| Ok(c.borrow().toast_count()))?,
    ...
    tbl.set("mousemoved", lua.create_function(move |_, (x, y): (f32, f32)| Ok(c.borrow_mut().mouse_moved(x, y)))?,
    ...
    tbl.set("keypressed", lua.create_function(move |_, key: String| Ok(c.borrow_mut().key_pressed(&key)))?,
    ...
    tbl.set("textinput", lua.create_function(move |_, text: String| Ok(c.borrow_mut().text_input(&text)))?,
    ...
    tbl.set("wheelmoved", lua.create_function(move |_, (x, y): (f32, f32)| Ok(c.borrow_mut().wheel_moved(x, y)))?,
    ...
    tbl.set("newCustomWidget", lua.create_function(move |lua, config: Option<LuaTable>| {
    ...
    tbl.set("getWidgetCount", lua.create_function(move |_, ()| Ok(c.borrow().widget_count()))?,
    ...
    tbl.set("drawToImage", lua.create_function(move |_, (w, h): (u32, u32)| {
    ...
    tbl.set("parseWidgetState", lua.create_function(|_, state: String| {
    ...
    tbl.set("newSpinBox", lua.create_function(move |lua, (min, max): (Option<f64>, Option<f64>)| {
    ...
    tbl.set("newSwitch", lua.create_function(move |lua, on: Option<bool>| {
    ...
    tbl.set("newBadge", lua.create_function(move |lua, count: Option<u32>| {
    ...
    tbl.set("setDefaultTheme", lua.create_function(move |_, ()| {
    ...
    tbl.set("setViewport", lua.create_function(move |_, (w, h): (f32, f32)| {
    ...
    tbl.set("flushCache", lua.create_function(move |_, ()| Ok(c.borrow_mut().flush_cache()))?,
    ...
    tbl.set("update_bindings", lua.create_function(move |_, data: mlua::Table| {
    ...
    tbl.set("loadLayout", lua.create_function(move |_, def: mlua::Table| {
    ...
    tbl.set("loadLayoutFile", lua.create_function(move |_, path: String| {
    ...
    tbl.set("renderToImage", lua.create_function(move |_, (width, height, path): (u32, u32, String)| {
