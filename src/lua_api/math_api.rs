...
pub struct LuaVec3 {
    /// Wrapped 3D vector value for this object.
    pub inner: Vec3,
}
...
impl LuaUserData for LuaVec3 {
    fn add_fields<'lua, F: LuaUserDataFields<'lua, Self>>(fields: &mut F) {
        ...
        /// Z component of the vector exposed by the lurek engine.
...
pub struct LuaHermite {
    /// Wrapped Hermite spline data for this object.
    inner: HermiteSpline,
}
...
pub struct LuaTransform {
    /// Wrapped transform value for this object.
    inner: Transform,
}
...
pub struct LuaBezierCurve {
    /// Wrapped Bezier curve data for this object.
    inner: BezierCurve,
}
...
pub struct LuaTween {
    /// Wrapped tween data for this object.
    inner: Tween,
}
...
pub struct LuaSpatialHash {
    /// Wrapped spatial hash data for this object.
    inner: SpatialHash,
}
...
pub struct LuaCircle {
    /// Wrapped circle data for this object.
    inner: Circle,
}
...
pub struct LuaAabbTree {
    /// Wrapped AABB tree data for this object.
    inner: AabbTree,
}
