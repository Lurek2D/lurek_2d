...
impl LuaUserData for LuaArray {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        methods.add_method(
            ...
            |lua, this, (bins, lo, hi): (usize, Option<f64>, Option<f64>)| {
                ...
                for (i, (bin_lo, bin_hi, count)) in bins_data.iter().enumerate() {
                    ...
                    /// The 'lo' field value exposed to Lua scripts.
                    entry.set("lo", *bin_lo)?;
                    /// The 'hi' field value exposed to Lua scripts.
                    entry.set("hi", *bin_hi)?;
        ...
        methods.add_method("sobel", |lua, this, ()| {
            ...
            /// The 'gx' field value exposed to Lua scripts.
            t.set("gx", lua.create_userdata(LuaArray { inner: gx })?)?;
            /// The 'gy' field value exposed to Lua scripts.
        ...
        methods.add_method("luDecompose", |lua, this, ()| {
            ...
            /// The 'n' field value exposed to Lua scripts.
