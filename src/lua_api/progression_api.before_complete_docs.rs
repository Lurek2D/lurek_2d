...
fn build_legacy_stats_adapter<'lua>(
    ...
    /// @param | this | table | Adapter table owning this operation.
    /// @param | name | string | Value supplied for `name`.
    /// @return | | boolean, string? | Success flag followed by an optional failure reason | Result produced by this progression operation.
    adapter.set(
        "useSkill",
        lua.create_function(|_, (this, name): (LuaTable, String)| {
            let store_ud: AnyUserData = this.get("_progression_store")?;
    ...
    ///
    /// @param | this | table | Adapter table owning this operation.
    /// @return | | number, number | Current action points followed by the configured maximum | Result produced by this progression operation.
    adapter.set(
        "getActionPoints",
        lua.create_function(|_, (this,): (LuaTable,)| {
            let store_ud: AnyUserData = this.get("_progression_store")?;
    ...
    ///
    /// @param | this | table | Adapter table owning this operation.
    /// @return | | number, number | Current morale followed by the configured maximum | Result produced by this progression operation.
    adapter.set(
        "getMorale",
        lua.create_function(|_, (this,): (LuaTable,)| {
            let store_ud: AnyUserData = this.get("_progression_store")?;
...
mod progression_objects_api_impl {
    ...
    impl UserData for LuaPopulation {
        ...
        fn add_methods<'lua, M: UserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            /// @return | | string | Population identifier | Result produced by this progression operation.
            methods.add_method("getId", |_, this, ()| snapshot_string(&this.snapshot, "id"));
    ...
    impl UserData for LuaPopulationProfile {
        ...
        fn add_methods<'lua, M: UserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            /// @return | | string | Virtual profile identifier | Result produced by this progression operation.
            methods.add_method("getProfileId", |_, this, ()| {
                snapshot_string(&this.snapshot, "profile_id")
            });
    ...
    impl UserData for LuaPrestige {
        ...
        fn add_methods<'lua, M: UserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            /// @return | | string | Prestige identifier | Result produced by this progression operation.
            methods.add_method("getId", |_, this, ()| snapshot_string(&this.snapshot, "id"));
    ...
    impl UserData for LuaQuestState {
        ...
        fn add_methods<'lua, M: UserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            /// @return | | string | Quest identifier | Result produced by this progression operation.
    ...
    impl UserData for LuaReward {
        ...
        fn add_methods<'lua, M: UserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            /// @return | | string | Stable reward identifier | Result produced by this progression operation.
            methods.add_method("getId", |_, this, ()| snapshot_string(&this.snapshot, "id"));
            /// Returns the current reward state.
            /// @return | | string | One of `"pending"`, `"claimed"`, `"applied"`, or `"rejected"` | Result produced by this progression operation.
