//! Defines the Lua API module layout and exports the binding owners that populate the shared `lurek` table.
...
pub mod docs_api;
/// Exposes the `lurek.dsp` binding module.
pub mod dsp_api;
...
pub mod layout_api;
/// Exposes the `lurek.learning` binding module.
