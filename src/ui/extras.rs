...
//!
//! - Data types: `Toast`, `Separator`, `Spacer`, `TreeNode`, and 17 more.
//! - Implementations: `Toast`, `Separator`, `Spacer`, `TreeNode`, and 14 more.
//! - Public methods: `new`, `progress`, `is_expired`, `update`, and 47 more.
//! - Contains 60 method implementations.
