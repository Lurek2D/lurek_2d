...
//!
//! - Data types: `LuaTween`, `LuaTweenSequence`, `ParallelEntry`, `LuaTweenParallel`.
//! - Enum: `SequenceStep`.
//! - Implementations: `LuaTween`, `LuaTweenSequence`, `LuaTweenParallel`.
//! - Public methods: `new`, `tick_with`, `fire_on_complete`, `set_relative`, and 12 more.
