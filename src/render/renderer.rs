...
//!
//! - Data types: `StencilMode`, `PostFxPass`, `TextSpan`, `TextureData`, and 4 more.
//! - Enums: `CompareMode`, `StencilAction`, `DepthMode`, `TextAlign`, and 9 more.
//! - Implementations: `StencilMode`, `TextSpan`, `PhysicsDebugConfig`.
//! - Public method: `new`.
