...
//!
//! - Data types: `AdjacencyPair`, `ProvinceShapeCacheEntry`, `ProvinceGrid`.
//! - Implementation: `ProvinceGrid`.
//! - Public methods: `from_image`, `from_file`, `width`, `height`, and 11 more.
//! - Contains 23 method implementations.
