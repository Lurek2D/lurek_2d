...
- **Forbidden Sections**: Contains a `## Key Types` section which belongs *only* in `docs/specs/light.md`.
- **Missing Required Link**: Lacks the `## Full Specification` section linking to `docs/specs/light.md`.
