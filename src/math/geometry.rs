...
//!
//! - Functions: `angle_between`, `circle_contains_point`, `circle_intersects_circle`, `circle_intersects_line`, and 10 more.
//! - See `docs/specs/math.md` for the module specification.
//! - Part of the `math` subsystem.
//! - See `src/math` for related modules (1).
