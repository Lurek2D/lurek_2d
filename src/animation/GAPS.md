...
- **Forbidden Sections**: Contains a `## Key Types` section which belongs *only* in `docs/specs/animation.md`.
- **Missing Required Link**: Lacks the `## Full Specification` section linking to `docs/specs/animation.md`.
