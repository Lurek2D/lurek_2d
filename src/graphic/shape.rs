...
//! [`crate::graphic::DrawCommand::DrawShape`] with a per-call affine transform.
//!
...
///
/// This is a restricted subset of [`crate::graphic::DrawCommand`] — only
...
/// coordinates and replays them as a unified entity via [`crate::graphic::DrawCommand::DrawShape`].
///
/// Build up commands with [`push_command`](CompoundShape::push_command), then submit
/// a [`crate::graphic::DrawCommand::DrawShape`] each frame to draw with an affine transform.
///
/// # Fields
