...
//!
//! - Data types: `Camera`, `Camera2D`.
//! - Enum: `CameraEasing`.
//! - Implementations: `CameraEasing`, `Camera`, `Camera2D`.
//! - Public methods: `apply`, `new`, `view_matrix`, `set_position`, and 52 more.

use crate::camera::effects::{CameraBreathing, CameraSway, ZoomPulse};
use crate::math::{Mat3, Rect, Vec2};

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
/// Selects easing behavior used by camera tween and follow interpolation.
...
impl CameraEasing {
    /// Evaluate easing curve and return clamped interpolation factor.
    pub fn apply(self, t: f32) -> f32 {
        let clamped = t.clamp(0.0, 1.0);
        match self {
            Self::Linear => crate::math::easing::linear(clamped),
            Self::SmoothStep => crate::math::easing::smooth_step(clamped),
            Self::EaseOutCubic => crate::math::easing::ease_out_cubic(clamped),
        }
    }
}
...
pub struct Camera2D {
    ...
    pub follow_easing: CameraEasing,
...
impl Camera2D {
    ...
    pub fn new(viewport_w: f32, viewport_h: f32) -> Self {
        Self {
            ...
            dead_zone: None,
            look_ahead: 0.0,
            follow_easing: CameraEasing::Linear,
            shake_intensity: 0.0,
            shake_duration: 0.0,
            shake_timer: 0.0,
    ...
    pub fn set_follow_easing(&mut self, easing: CameraEasing) {
        self.follow_easing = easing;
    }
    /// Read follow easing mode and return selected easing enum.
    pub fn get_follow_easing(&self) -> CameraEasing {
        self.follow_easing
    }
