...
//!
//! - Data types: `CameraPath`, `CameraZoomTween`.
//! - Type aliases: `CameraTweenEasing`, `ZoomTween`.
...
/// Type alias for backwards compatibility with code referencing CameraTweenEasing.
pub type CameraTweenEasing = CameraEasing;
...
impl CameraZoomTween {
    ...
    pub fn new(start_zoom: f32, target_zoom: f32, duration: f32) -> Self {
        Self::new_with_easing(start_zoom, target_zoom, duration, CameraEasing::Linear)
    }
