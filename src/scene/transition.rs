...
//!
//! - Data type: `ActiveTransition`.
//! - Enums: `TransitionType`, `EasingType`.
...
impl EasingType {
    ...
    pub fn apply(self, t: f32) -> f32 {
        ...
        match self {
            ...
            Self::EaseIn => easing::ease_in_quad(t),
            Self::EaseOut => easing::ease_out_quad(t),
            Self::EaseInOut => easing::smooth_step(t),
            Self::Bounce => 1.0 - easing::ease_out_bounce(1.0 - t),
            Self::Back => easing::ease_in_back(t),
        }
    }
}
