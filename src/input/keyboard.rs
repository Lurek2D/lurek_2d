...
pub fn winit_scancode_to_string(code: winit::keyboard::KeyCode) -> Option<&'static str> {
    ...
    match code {
        ...
        KeyCode::SuperLeft => Some("lsuper"),
        KeyCode::SuperRight => Some("rsuper"),
        KeyCode::ContextMenu => Some("menu"),
        ...
        KeyCode::Slash => Some("/"),
        KeyCode::IntlBackslash => Some("intlbackslash"),
        KeyCode::IntlRo => Some("intlro"),
        KeyCode::IntlYen => Some("intlyen"),
        KeyCode::BrowserBack => Some("browserback"),
        KeyCode::BrowserForward => Some("browserforward"),
        KeyCode::BrowserRefresh => Some("browserrefresh"),
        KeyCode::AudioVolumeMute => Some("volumemute"),
        KeyCode::AudioVolumeDown => Some("volumedown"),
        KeyCode::AudioVolumeUp => Some("volumeup"),
        KeyCode::MediaPlayPause => Some("mediaplaypause"),
        KeyCode::MediaTrackNext => Some("medianext"),
        KeyCode::MediaTrackPrevious => Some("mediaprevious"),
