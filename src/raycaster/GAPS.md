...
- **Forbidden Sections**: Contains a `## Key Types` section which belongs *only* in `docs/specs/raycaster.md`.
- **Missing Required Link**: Lacks the `## Full Specification` section linking to `docs/specs/raycaster.md`.
