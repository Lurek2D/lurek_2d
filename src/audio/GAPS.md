# Gap Analysis: `src/audio`

## 1. Architecture & Compliance
- **Dependency Direction**: Review required. Must not depend on Feature Systems.
...
- **Forbidden Sections**: Contains a `## Key Types` section which belongs *only* in docs.
- **Missing Required Link**: Lacks the `## Full Specification` section linking to `docs/specs/audio.md`.
