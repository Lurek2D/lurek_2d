...
- Stale: AGENT-era rewrite asks are obsolete because canonical module guidance now lives in `docs/specs/procgen.md`.
...
## Evidence
- `docs/specs/procgen.md`
- `docs/specs/README.md`
- `src/procgen/mod.rs`
- `src/lua_api/procgen_api.rs`
