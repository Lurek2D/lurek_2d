...
- Canonical module reference: `docs/specs/ecs.md`

This refresh treats the current workspace state as the source of truth; older gap-analysis text is historical only.

## Open items
- None for the current baseline. Revalidate against `docs/specs/ecs.md` before treating any legacy gap note as active work.
