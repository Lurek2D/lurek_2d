...
/// A node in a dialogue tree that can represent a line of text,
/// a choice point, or a scripted action.
#[derive(Debug, Clone)]
pub struct DialogueNode {
    /// Unique identifier for this node.
    pub id: String,
    /// Speaker identifier (references SpeakerRegistry).
    pub speaker: Option<String>,
    /// Text content displayed to the player.
    pub text: String,
    /// Child node IDs (branches from this node).
    pub children: Vec<String>,
    /// Optional condition that must pass for this node to be available.
...
impl DialogueNode {
    /// Create a new dialogue node with the given id and text.
