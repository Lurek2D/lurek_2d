...
- Canonical module reference: `docs/specs/mods.md`

This refresh treats the current workspace state as the source of truth; older gap-analysis text is historical only.

## Open items
- None for the current baseline. Revalidate against `docs/specs/mods.md` before treating any legacy gap note as active work.
