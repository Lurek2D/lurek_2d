# Gap Analysis: `src/pathfind`

## 1. Architecture & Compliance
- **Dependency Direction**: Feature Systems.
...
- **Forbidden Sections**: Contains a `## Key Types` section which belongs *only* in `docs/specs/pathfind.md`.
