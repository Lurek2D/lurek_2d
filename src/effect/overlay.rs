...
mod tests {
    ...
    fn trigger_shake_produces_offset() {
        ...
        // After update, at least one offset should be non-zero
    ...
    fn ambient_color_auto_updates_when_enabled() {
        let mut o = Overlay::new(800, 600);
        o.ambient.enabled = true;
        o.ambient.time_of_day = 2.0; // night
        o.update(0.0);
        // Ambient color should now reflect night values
