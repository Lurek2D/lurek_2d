...
-- reports/P0_library_audit.md -ş2.4 for the original defect citation.
...
-- work/library-overhaul-20260418/reports/P0_library_audit.md -ş2.4.
...
-- See work/library-overhaul-20260418/reports/P0_library_audit.md -ş2.4.
...
function M.newUpgradeTree(name)
    return setmetatable({
        name   = name,
        _nodes = {},
        _edges = {},   -- parent_id Ôcl {child_id, ...}
        _order = {},   -- insertion order for nodeIds()
        _parent = {},  -- child_id Ôcl parent_id
    }, UpgradeTree)
end
