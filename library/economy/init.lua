...
--- @see lurek.serialize.toJson         serialise resources/rules/modifiers for save persistence
--- @see lurek.serialize.fromJson       restore manager state from a JSON snapshot
