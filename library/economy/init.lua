...
--- @see lurek.serializeize.toJson         serialise resources/rules/modifiers for save persistence
--- @see lurek.serializeize.fromJson       restore manager state from a JSON snapshot
