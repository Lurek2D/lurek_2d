...
-- lifecycle events. Optional JSON round-trip via lurek.serialize is
...
-- ── 6. Optional JSON round-trip via lurek.serialize (guarded) ─────────────────────
...
if lurek_ok and lurek and lurek.serialize and lurek.serialize.toJson then
    ...
    print("[example.quest] lurek.serialize unavailable; skipped JSON round-trip")
end
