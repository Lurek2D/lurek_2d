...
fn create_test_vm() -> mlua::Lua {
    ...
    // Load test framework
    let framework = include_str!("lua_reorg/init.lua");
    lua.load(framework)
...
fn run_lua_test(filename: &str) {
    let rooted = format!("tests/lua_reorg/{}", filename);
...
/// Collect `tests/lua_reorg/demos/test_*.lua` headless demo contract tests.
...
#[test]
fn lua_reorg_golden_animation_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_audio_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_binary_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_camera_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_compute_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_dataframe_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_ecs_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_html_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_globe_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_image_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_light_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_math_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_minimap_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_overlay_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_particle_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_pathfind_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_physics_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_procgen_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_raycaster_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_render_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_scene_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_serialize_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_spine_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_svg_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_golden_tilemap_golden() {
    run_lua_golden_test(
...
#[test]
fn lua_reorg_demos_headless_all() {
    let dir = Path::new("tests/lua_reorg/demos");
    let mut paths = Vec::new();
    collect_headless_demo_tests(dir, &mut paths);
    paths.sort();
    for path in &paths {
        let display = path.to_str().expect("non-utf8 demo test path");
        run_lua_workspace_test(display);
    }
}
