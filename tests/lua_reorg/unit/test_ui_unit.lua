...
-- @describe ui chart owner coverage
describe("ui chart owner coverage", function()
    -- @covers LLineChart:addSeriesFromDataFrame
    it("line chart addSeriesFromDataFrame skips non numeric points", function()
        local df = lurek.dataframe.fromRows({ "month", "savings" }, {
            { 1, 240 },
            { 2, "260" },
            { 3, "bad" },
        })
        local chart = lurek.ui.newLineChart({ width = 64, height = 64 })
    ...
    it("line chart setYMax keeps the chart drawable", function()
        local chart = lurek.ui.newLineChart({ width = 64, height = 64 })
        chart:setYMax(50)
        chart:addSeries("speed", { { 1, 10 }, { 2, 20 }, { 3, 15 } }, 0.2, 0.8, 0.4)
        expect_chart_draws(chart, 64, 64)
    end)

    -- @covers LLineChart:setXMax
    it("line chart setXMax keeps the chart drawable", function()
        local chart = lurek.ui.newLineChart({ width = 64, height = 64 })
        chart:setXMax(10)
        chart:addSeries("speed", { { 1, 10 }, { 2, 20 }, { 10, 15 } }, 0.8, 0.3, 0.2)
        expect_chart_draws(chart, 64, 64)
    end)

    -- @covers LLineChart:drawToImage
    it("line chart drawToImage writes visible pixels", function()
        local chart = lurek.ui.newLineChart({ width = 64, height = 64 })
        chart:addSeries("speed", { { 1, 10 }, { 2, 20 }, { 3, 15 } }, 0.2, 0.8, 0.4)
        expect_chart_draws(chart, 64, 64)
    end)
    ...
    it("line chart type returns LLineChart", function()
        expect_equal("LLineChart", lurek.ui.newLineChart({ width = 64, height = 64 }):type())
    end)

    -- @covers LLineChart:typeOf
    it("line chart typeOf recognizes LLineChart", function()
        expect_true(lurek.ui.newLineChart({ width = 64, height = 64 }):typeOf("LLineChart"))
    end)

    -- @covers LBarChart:addCategory
    it("bar chart addCategory adds drawable category data", function()
        local chart = lurek.ui.newBarChart({ width = 64, height = 64 })
    ...
    it("bar chart addCategoriesFromDataFrame copies dataframe rows", function()
        local df = lurek.dataframe.fromRows({ "month", "income", "expense" }, {
            { "Jan", 100, 60 },
            { "Feb", "120", "bad" },
        })
        local chart = lurek.ui.newBarChart({ width = 64, height = 64 })
        ...
        expect_equal(2, chart:addCategoriesFromDataFrame(df, "month", { "income", "expense" }))
    end)

    -- @covers LBarChart:drawToImage
    it("bar chart drawToImage writes visible pixels", function()
        local chart = lurek.ui.newBarChart({ width = 64, height = 64 })
        chart:addSeries("Q1", 0.2, 0.6, 1.0)
    ...
    it("bar chart type returns LBarChart", function()
        expect_equal("LBarChart", lurek.ui.newBarChart({ width = 64, height = 64 }):type())
    end)

    -- @covers LBarChart:typeOf
    it("bar chart typeOf recognizes LBarChart", function()
        expect_true(lurek.ui.newBarChart({ width = 64, height = 64 }):typeOf("LBarChart"))
    end)

    -- @covers LScatterPlot:addSeriesFromDataFrame
    it("scatter plot addSeriesFromDataFrame skips non numeric points", function()
        local df = lurek.dataframe.fromRows({ "x", "y" }, {
            { 1, 2 },
            { 3, 4 },
            { 5, "bad" },
        })
        local chart = lurek.ui.newScatterPlot({ width = 64, height = 64 })
        local count = chart:addSeriesFromDataFrame("Points", df, "x", "y", 0.2, 0.7, 0.9)
        expect_equal(2, count)
    end)

    -- @covers LScatterPlot:setXRange
    it("scatter plot setXRange keeps the chart drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 64, height = 64 })
        chart:setXRange(0, 10)
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.2, 0.7, 0.9)
        expect_chart_draws(chart, 64, 64)
    end)

    -- @covers LScatterPlot:setYRange
    it("scatter plot setYRange keeps the chart drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 64, height = 64 })
        chart:setYRange(0, 10)
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.9, 0.4, 0.2)
        expect_chart_draws(chart, 64, 64)
    end)

    -- @covers LScatterPlot:drawToImage
    it("scatter plot drawToImage writes visible pixels", function()
        local chart = lurek.ui.newScatterPlot({ width = 64, height = 64 })
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.2, 0.7, 0.9)
        expect_chart_draws(chart, 64, 64)
    end)
    ...
    it("scatter plot type returns LScatterPlot", function()
        expect_equal("LScatterPlot", lurek.ui.newScatterPlot({ width = 64, height = 64 }):type())
    end)

    -- @covers LScatterPlot:typeOf
    it("scatter plot typeOf recognizes LScatterPlot", function()
        expect_true(lurek.ui.newScatterPlot({ width = 64, height = 64 }):typeOf("LScatterPlot"))
    end)

    -- @covers LPieChart:addSegment
    it("pie chart addSegment adds drawable segment data", function()
        local chart = lurek.ui.newPieChart({ width = 64, height = 64 })
        chart:addSegment("Food", 420, 0.8, 0.3, 0.2)
        expect_chart_draws(chart, 64, 64)
    end)

    -- @covers LPieChart:addSegmentsFromDataFrame
    it("pie chart addSegmentsFromDataFrame skips invalid values", function()
    ...
    it("pie chart drawToImage writes visible pixels", function()
        local chart = lurek.ui.newPieChart({ width = 64, height = 64 })
        chart:addSegment("Food", 420, 0.8, 0.3, 0.2)
        expect_chart_draws(chart, 64, 64)
    end)
    ...
    it("pie chart type returns LPieChart", function()
        expect_equal("LPieChart", lurek.ui.newPieChart({ width = 64, height = 64 }):type())
    end)

    -- @covers LPieChart:typeOf
    it("pie chart typeOf recognizes LPieChart", function()
        expect_true(lurek.ui.newPieChart({ width = 64, height = 64 }):typeOf("LPieChart"))
    end)

    -- @covers LAreaChart:addLayer
    it("area chart addLayer adds drawable layer data", function()
    ...
    it("area chart addLayerFromDataFrame copies dataframe values", function()
        ...
        local chart = lurek.ui.newAreaChart({ width = 64, height = 64 })
        expect_equal(3, chart:addLayerFromDataFrame("Balance", df, "balance", 0.2, 0.6, 0.9))
    end)

    -- @covers LAreaChart:setYMax
    it("area chart setYMax keeps the chart drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 64, height = 64 })
        chart:setYMax(100)
        chart:addLayer("series1", { 10, 20, 30, 25, 15 }, 1.0, 0.2, 0.2)
        expect_chart_draws(chart, 64, 64)
    ...
    it("area chart drawToImage writes visible pixels", function()
        local chart = lurek.ui.newAreaChart({ width = 64, height = 64 })
        chart:addLayer("series1", { 10, 20, 30, 25, 15 }, 1.0, 0.2, 0.2)
        expect_chart_draws(chart, 64, 64)
    end)
    ...
    it("area chart type returns LAreaChart", function()
        expect_equal("LAreaChart", lurek.ui.newAreaChart({ width = 64, height = 64 }):type())
    end)

    -- @covers LAreaChart:typeOf
    it("area chart typeOf recognizes LAreaChart", function()
        expect_true(lurek.ui.newAreaChart({ width = 64, height = 64 }):typeOf("LAreaChart"))
    end)

    -- @covers LLineChart:setXLabel
    it("line chart setXLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newLineChart({ width = 96, height = 72 })
    ...
    it("line chart setYLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newLineChart({ width = 96, height = 72 })
    ...
    it("line chart setXTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newLineChart({ width = 96, height = 72 })
    ...
    it("line chart setYTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newLineChart({ width = 96, height = 72 })
    ...
    it("line chart setShowLegend keeps annotated charts drawable", function()
        local chart = lurek.ui.newLineChart({ width = 96, height = 72 })
    ...
    it("bar chart setXLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newBarChart({ width = 96, height = 72 })
    ...
    it("bar chart setYLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newBarChart({ width = 96, height = 72 })
    ...
    it("bar chart setXTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newBarChart({ width = 96, height = 72 })
        chart:setXTickCount(6)
        chart:addSeries("Q1", 0.2, 0.6, 1.0)
        chart:addCategory("Jan", { 30 })
    ...
    it("bar chart setYTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newBarChart({ width = 96, height = 72 })
        chart:setYTickCount(6)
        chart:addSeries("Q1", 0.2, 0.6, 1.0)
        chart:addCategory("Jan", { 30 })
    ...
    it("bar chart setShowLegend keeps annotated charts drawable", function()
        local chart = lurek.ui.newBarChart({ width = 96, height = 72 })
        chart:setShowLegend(true)
        chart:addSeries("Q1", 0.2, 0.6, 1.0)
        chart:addCategory("Jan", { 30 })
    ...
    it("scatter plot setXLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 96, height = 72 })
    ...
    it("scatter plot setYLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 96, height = 72 })
    ...
    it("scatter plot setXTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 96, height = 72 })
        chart:setXTickCount(6)
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.2, 0.7, 0.9)
        expect_chart_draws(chart, 96, 72)
    ...
    it("scatter plot setYTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 96, height = 72 })
        chart:setYTickCount(6)
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.2, 0.7, 0.9)
        expect_chart_draws(chart, 96, 72)
    ...
    it("scatter plot setShowLegend keeps annotated charts drawable", function()
        local chart = lurek.ui.newScatterPlot({ width = 96, height = 72 })
        chart:setShowLegend(true)
        chart:addSeries("Points", { { 1, 2 }, { 3, 4 }, { 5, 6 } }, 0.2, 0.7, 0.9)
        expect_chart_draws(chart, 96, 72)
    ...
    it("pie chart setShowLegend keeps annotated charts drawable", function()
        local chart = lurek.ui.newPieChart({ width = 96, height = 72 })
        chart:setShowLegend(true)
        chart:addSegment("Food", 420, 0.8, 0.3, 0.2)
        expect_chart_draws(chart, 96, 72)
    end)
    ...
    it("area chart setXLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 96, height = 72 })
    ...
    it("area chart setYLabel keeps annotated charts drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 96, height = 72 })
    ...
    it("area chart setXTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 96, height = 72 })
        chart:setXTickCount(6)
        chart:addLayer("series1", { 10, 20, 30, 25, 15 }, 1.0, 0.2, 0.2)
        expect_chart_draws(chart, 96, 72)
    ...
    it("area chart setYTickCount keeps annotated charts drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 96, height = 72 })
        chart:setYTickCount(6)
        chart:addLayer("series1", { 10, 20, 30, 25, 15 }, 1.0, 0.2, 0.2)
        expect_chart_draws(chart, 96, 72)
    ...
    it("area chart setShowLegend keeps annotated charts drawable", function()
        local chart = lurek.ui.newAreaChart({ width = 96, height = 72 })
        chart:setShowLegend(true)
        chart:addLayer("series1", { 10, 20, 30, 25, 15 }, 1.0, 0.2, 0.2)
        expect_chart_draws(chart, 96, 72)
