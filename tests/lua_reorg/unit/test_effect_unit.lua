...
describe("LPostFxStack methods", function()
    ...
    it("remove deletes a specific effect object", function()
        local stack = new_stack()
        local effect = new_effect("blur")
        stack:add(effect)
        stack:remove(effect)
    ...
    it("dedup removes repeated effect objects", function()
        local stack = new_stack()
        local effect = new_effect("blur")
        stack:add(effect)
        stack:add(effect)
    ...
    it("insert places an effect at a given position", function()
        local stack = new_stack()
        stack:add(new_effect("bloom"))
