...
describe("province explicit owner coverage", function()
    ...
    it("accepts a capital marker update on a known province id", function()
        local reg = province_registry("set_capital", "content/games/strategy/eu2/map.png")
        local id = 1
    ...
    it("accepts a label line update on a known province id", function()
        local reg = province_registry("set_label_line", "content/games/strategy/eu2/map.png")
        local id = 1
    ...
    it("accepts a label text update on a known province id", function()
        local reg = province_registry("set_label_text", "content/games/strategy/eu2/map.png")
        local id = 1
