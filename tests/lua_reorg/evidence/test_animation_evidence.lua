...
describe("Evidence: lurek.animation API", function()
    ...
    -- @evidence LAnimation:addClip
    -- @evidence LAnimation:addClipFromGrid
    -- @evidence LAnimation:addFrame
    -- @evidence LAnimation:addFramesFromRects
    -- @evidence LAnimation:getClip
    -- @evidence LAnimation:getClipCount
    -- @evidence LAnimation:getClipMode
    -- @evidence LAnimation:setClipMode
    -- @evidence LAnimation:getSpeed
    -- @evidence LAnimation:setSpeed
    -- @evidence LAnimation:setFrame
    -- @evidence LAnimation:isPlaying
    -- @evidence LAnimation:isLooping
    -- @evidence LAnimation:pause
    -- @evidence LAnimation:resume
    -- @evidence LAnimation:pollEvents
    -- @evidence LAnimation:stop
