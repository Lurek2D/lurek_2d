...
describe("Evidence: lurek.tilemap scenarios", function()
    ...
    -- @evidence lurek.tilemap.newTileMap
    -- @evidence LTileMap:addLayer
    -- @evidence LTileMap:fill
    -- @evidence LTileMap:setTile
    -- @evidence LTileMap:drawToImage
    -- @evidence lurek.image.savePNG
    ...
    -- @evidence lurek.tilemap.toScreenHex
    -- @evidence lurek.tilemap.hexArea
    -- @evidence lurek.tilemap.hexLine
    -- @evidence lurek.tilemap.hexRing
    -- @evidence lurek.tilemap.hexNeighbors
    -- @evidence lurek.image.savePNG
