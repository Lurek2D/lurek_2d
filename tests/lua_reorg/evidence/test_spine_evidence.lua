...
describe("Evidence: lurek.spine API", function()
    ...
    -- @evidence LSkeleton:addIKConstraint
    -- @evidence LSkeleton:setIKTarget
    -- @evidence LSkeleton:updateWorldTransforms
    -- @evidence lurek.image.savePNG
    ...
    -- @evidence LSkeleton:addSkin
    -- @evidence LSkeleton:getSkin
    -- @evidence LSkeleton:setSkin
    -- @evidence LSkeleton:setSkinMapping
    -- @evidence LSkeletonAnimation:addEventKey
    -- @evidence LSkeletonAnimation:getEvents
    -- @evidence LSkeletonAnimation:poseAt
    ...
    -- @evidence lurek.spine.animationFromJson
    -- @evidence lurek.spine.skeletonFromJson
    -- @evidence LSkeleton:addAnimation
    -- @evidence LSkeleton:playAnimation
    -- @evidence LSkeleton:updateAnimation
    -- @evidence LSkeleton:drawToImage
