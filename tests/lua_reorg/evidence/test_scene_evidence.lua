...
describe("Evidence: lurek.scene state registry and serialization", function()
    ...
    -- @evidence lurek.scene.clear
    -- @evidence lurek.scene.setData
    -- @evidence lurek.scene.getData
    -- @evidence lurek.scene.serializeScene
    -- @evidence lurek.scene.deserializeScene
    -- @evidence lurek.scene.preload
    -- @evidence lurek.scene.isPreloaded
    -- @evidence lurek.scene.pushPreloaded
    -- @evidence lurek.scene.pushOverlay
    -- @evidence lurek.scene.getActiveScenes
...
describe("Evidence: lurek.scene object container flow", function()
    ...
    -- @evidence lurek.scene.newObjectContainer
    -- @evidence LSceneObjectContainer:add
    -- @evidence LSceneObjectContainer:update
    -- @evidence LSceneObjectContainer:draw
    -- @evidence LSceneObjectContainer:getCount
    -- @evidence LSceneObjectContainer:getObjects
    -- @evidence LSceneObjectContainer:getByLayer
    -- @evidence LSceneObjectContainer:has
    -- @evidence LSceneObjectContainer:remove
    -- @evidence LSceneObjectContainer:clear
    -- @evidence LSceneObjectContainer:type
    -- @evidence LSceneObjectContainer:typeOf
