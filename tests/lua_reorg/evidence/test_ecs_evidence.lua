...
describe("Evidence: lurek.ecs data outputs", function()
    ...
    -- @evidence LUniverse:spawn
    -- @evidence LUniverse:isAlive
    -- @evidence LUniverse:getEntityCount
    -- @evidence LUniverse:getEntities
    -- @evidence LUniverse:kill
    ...
    -- @evidence LUniverse:set
    -- @evidence LUniverse:get
    -- @evidence LUniverse:has
    -- @evidence LUniverse:remove
    -- @evidence LUniverse:getComponents
    -- @evidence LUniverse:query
    -- @evidence LUniverse:queryNot
    -- @evidence LUniverse:getDirtyEntities
    ...
    -- @evidence LUniverse:addTag
    -- @evidence LUniverse:getEntitiesByTag
    -- @evidence LUniverse:defineTag
    -- @evidence LUniverse:bitmapTag
    -- @evidence LUniverse:queryBitmapAny
    -- @evidence LUniverse:setLayer
    -- @evidence LUniverse:getEntitiesSorted
    ...
    -- @evidence LUniverse:defineBlueprint
    -- @evidence LUniverse:extendBlueprint
    -- @evidence LUniverse:spawnBlueprint
    -- @evidence LUniverse:spawnBulk
    -- @evidence LUniverse:listBlueprints
    -- @evidence LUniverse:getBlueprintComponents
    ...
    -- @evidence LUniverse:addSystem
    -- @evidence LUniverse:getSystemCount
    -- @evidence LUniverse:update
    -- @evidence LUniverse:emit
    -- @evidence LUniverse:serialize
    -- @evidence LUniverse:deserialize
    -- @evidence LUniverse:snapshot
    -- @evidence LUniverse:applySnapshot
    -- @evidence LUniverse:takeSnapshotDiff
    ...
    -- @evidence LUniverse:flushObservers
    -- @evidence LUniverse:onComponentAdded
    -- @evidence LUniverse:onComponentRemoved
    -- @evidence LUniverse:setParent
    -- @evidence LUniverse:getParent
    -- @evidence LUniverse:getChildren
    -- @evidence LUniverse:addRelation
    -- @evidence LUniverse:getRelated
    -- @evidence LUniverse:hasRelation
    -- @evidence LUniverse:removeRelation
    -- @evidence LUniverse:clearRelations
    -- @evidence LUniverse:killRecursive
