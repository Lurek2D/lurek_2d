...
describe("Evidence: lurek.minimap API + PNG visualization", function()
    ...
    -- Additional multi-floor evidence
    -- @evidence lurek.image.savePNG
    ...
    -- Additional unexplored-mask evidence
    -- @evidence lurek.image.savePNG
    ...
    -- Additional circular-border evidence
    -- @evidence lurek.image.savePNG
