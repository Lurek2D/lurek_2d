-- tests/lua_reorg/library/test_loot_library.lua
...
-- @describe LootTable.sample distribution
describe("LootTable.sample distribution", function()
    -- @library LRandomGenerator:setSeed
    -- @library lurek.math.newRandomGenerator
