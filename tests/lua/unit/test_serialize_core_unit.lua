...
-- @describe lurek.serialize module exists
describe("lurek.serialize module exists", function()
    -- @covers lurek.serialize
    it("lurek.serialize is a table", function()
...
-- @describe lurek.serialize regression coverage
describe("lurek.serialize regression coverage", function()
  -- @covers lurek.serial.decodeMsgPack
  -- @covers lurek.serial.encodeMsgPack
...
-- @describe lurek.serialize unified codec API
describe("lurek.serialize unified codec API", function()
