...
-- =========================================================================
-- 1. luna.ui module exists
-- =========================================================================
describe("luna.ui module exists", function()
    it("luna.ui is a table", function()
        expect_type("table", luna.ui)
    end)

    it("has newButton factory", function()
        expect_type("function", luna.ui.newButton)
    end)

    it("has newLabel factory", function()
        expect_type("function", luna.ui.newLabel)
    end)

    it("has newTextInput factory", function()
        expect_type("function", luna.ui.newTextInput)
    end)

    it("has newCheckbox factory", function()
        expect_type("function", luna.ui.newCheckbox)
    end)

    it("has newSlider factory", function()
        expect_type("function", luna.ui.newSlider)
    end)

    it("has newProgressBar factory", function()
        expect_type("function", luna.ui.newProgressBar)
    end)

    it("has newComboBox factory", function()
        expect_type("function", luna.ui.newComboBox)
    end)

    it("has newList factory", function()
        expect_type("function", luna.ui.newList)
    end)

    it("has newPanel factory", function()
        expect_type("function", luna.ui.newPanel)
    end)

    it("has newLayout factory", function()
        expect_type("function", luna.ui.newLayout)
    end)

    it("has newScrollPanel factory", function()
        expect_type("function", luna.ui.newScrollPanel)
    end)

    it("has newNinePatch factory", function()
        expect_type("function", luna.ui.newNinePatch)
    end)

    it("has newTabBar factory", function()
        expect_type("function", luna.ui.newTabBar)
    end)

    it("has newSeparator factory", function()
        expect_type("function", luna.ui.newSeparator)
    end)

    it("has newSpacer factory", function()
        expect_type("function", luna.ui.newSpacer)
    end)

    it("has newToast factory", function()
        expect_type("function", luna.ui.newToast)
    end)

    it("has newTreeView factory", function()
        expect_type("function", luna.ui.newTreeView)
    end)

    it("has newTheme factory", function()
        expect_type("function", luna.ui.newTheme)
    end)

    it("has setTheme function", function()
        expect_type("function", luna.ui.setTheme)
    end)

    it("has getTheme function", function()
        expect_type("function", luna.ui.getTheme)
    end)

    it("has setFocus function", function()
        expect_type("function", luna.ui.setFocus)
    end)

    it("has getFocus function", function()
        expect_type("function", luna.ui.getFocus)
    end)

    it("has focusNext function", function()
        expect_type("function", luna.ui.focusNext)
    end)

    it("has focusPrev function", function()
        expect_type("function", luna.ui.focusPrev)
    end)

    it("has clearFocus function", function()
        expect_type("function", luna.ui.clearFocus)
    end)

    it("has getRoot function", function()
        expect_type("function", luna.ui.getRoot)
    end)

    it("has update function", function()
        expect_type("function", luna.ui.update)
    end)

    it("has draw function", function()
        expect_type("function", luna.ui.draw)
    end)

    it("has getWidgetCount function", function()
        expect_type("function", luna.ui.getWidgetCount)
    end)

    it("has input routing functions", function()
        expect_type("function", luna.ui.mousepressed)
        expect_type("function", luna.ui.mousereleased)
        expect_type("function", luna.ui.mousemoved)
        expect_type("function", luna.ui.keypressed)
        expect_type("function", luna.ui.textinput)
        expect_type("function", luna.ui.wheelmoved)
    end)

    it("has toast functions", function()
        expect_type("function", luna.ui.addToast)
        expect_type("function", luna.ui.getToastCount)
    end)
end)
...
-- 4. TextInput
-- =========================================================================
describe("luna.ui TextInput", function()
...
describe("luna.ui CheckBox", function()
    ...
    it("can set and get text", function()
        local cb = luna.ui.newCheckbox("old")
        cb.setText("new")
...
-- 7. ProgressBar
-- =========================================================================
describe("luna.ui ProgressBar", function()
    it("creates with defaults", function()
        local pb = luna.ui.newProgressBar()
...
-- 8. ComboBox
-- =========================================================================
describe("luna.ui ComboBox", function()
    it("creates empty", function()
        local cb = luna.ui.newComboBox()
...
-- 9. ListBox
-- =========================================================================
describe("luna.ui ListBox", function()
    it("creates empty", function()
...
-- 10. TabBar
-- =========================================================================
describe("luna.ui TabBar", function()
    it("creates empty", function()
        local tb = luna.ui.newTabBar()
...
-- =========================================================================
describe("luna.ui widget base methods", function()
    it("can set and get position", function()
        local btn = luna.ui.newButton("Pos")
    ...
    it("can set and get size", function()
        local btn = luna.ui.newButton("Size")
        btn.setSize(300, 150)
    ...
    it("can set and get visibility", function()
        local btn = luna.ui.newButton("Vis")
    ...
    it("can set and get enabled state", function()
        local btn = luna.ui.newButton("En")
    ...
    it("can set padding (1 value = uniform)", function()
        local btn = luna.ui.newButton("Pad1")
        btn.setPadding(5)
        local t, r, b, l = btn.getPadding()
        expect_equal(5, t)
        expect_equal(5, r)
    ...
    it("can set and get margin", function()
        local btn = luna.ui.newButton("Mar")
    ...
    it("contains point hit test", function()
        local btn = luna.ui.newButton("Hit")
    ...
    it("can set and get min size", function()
        local btn = luna.ui.newButton("Min")
    ...
    it("can set and get max size", function()
        local btn = luna.ui.newButton("Max")
    ...
    it("can set flex grow and shrink", function()
        local btn = luna.ui.newButton("Flex")
        btn.setFlexGrow(2.0)
    ...
    it("getState returns a string", function()
        local btn = luna.ui.newButton("State")
...
-- 12. Panel (container)
-- =========================================================================
describe("luna.ui Panel", function()
    it("creates a panel", function()
        local p = luna.ui.newPanel()
        expect_type("table", p)
    end)

    it("can add and count children", function()
        local p = luna.ui.newPanel()
        local b1 = luna.ui.newButton("A")
        local b2 = luna.ui.newButton("B")
        p.addChild(b1)
        p.addChild(b2)
...
-- 14. ScrollPanel
-- =========================================================================
describe("luna.ui ScrollPanel", function()
    it("creates a scroll panel", function()
        local sp = luna.ui.newScrollPanel()
...
-- 15. NinePatch
-- =========================================================================
describe("luna.ui NinePatch", function()
    it("creates a nine-patch widget", function()
        local np = luna.ui.newNinePatch()
...
-- 18. Toast
-- =========================================================================
describe("luna.ui Toast", function()
    it("creates a toast", function()
        local t = luna.ui.newToast("Hello!", 3.0)
        expect_type("table", t)
    end)

    it("can add toast to context", function()
        local t = luna.ui.newToast("Msg", 2.0)
        luna.ui.addToast(t)
        local count = luna.ui.getToastCount()
...
-- 19. TreeView
-- =========================================================================
describe("luna.ui TreeView", function()
    it("creates empty tree", function()
        local tv = luna.ui.newTreeView()
...
-- =========================================================================
describe("luna.ui widget count", function()
    it("getWidgetCount returns a number", function()
        local count = luna.ui.getWidgetCount()
...
-- 21. Focus management
-- =========================================================================
describe("luna.ui focus", function()
    ...
    it("getFocus returns nil when no focus", function()
        luna.ui.clearFocus()
        local f = luna.ui.getFocus()
        expect_equal(nil, f)
    end)

    it("setFocus and getFocus work", function()
        local btn = luna.ui.newButton("Focus Test")
        luna.ui.setFocus(btn)
        local f = luna.ui.getFocus()
        expect_type("number", f)
    end)

    it("focusNext moves focus", function()
        local b1 = luna.ui.newButton("N1")
        local b2 = luna.ui.newButton("N2")
        luna.ui.setFocus(b1)
        luna.ui.focusNext()
...
-- 22. Input routing
-- =========================================================================
describe("luna.ui input routing", function()
    it("mousepressed returns boolean", function()
        local consumed = luna.ui.mousepressed(100, 100, 1)
        expect_type("boolean", consumed)
    end)

    it("mousereleased returns boolean", function()
        local consumed = luna.ui.mousereleased(100, 100, 1)
        expect_type("boolean", consumed)
    end)

    it("mousemoved returns boolean", function()
        local consumed = luna.ui.mousemoved(100, 100, 0, 0)
        expect_type("boolean", consumed)
    end)

    it("keypressed returns boolean", function()
        local consumed = luna.ui.keypressed("tab")
        expect_type("boolean", consumed)
    end)

    it("textinput returns boolean", function()
        local consumed = luna.ui.textinput("a")
        expect_type("boolean", consumed)
    end)

    it("wheelmoved returns boolean", function()
        local consumed = luna.ui.wheelmoved(0, -1)
        expect_type("boolean", consumed)
    end)
end)
...
-- =========================================================================
describe("luna.ui update and draw", function()
    it("update runs without error", function()
        luna.ui.update(0.016)
    end)
...
-- 24. Theme
-- =========================================================================
describe("luna.ui Theme", function()
...
-- 25. findById
-- =========================================================================
describe("luna.ui findById", function()
    it("finds a widget by id", function()
        local btn = luna.ui.newButton("Find Me")
...
-- =========================================================================
describe("luna.ui callbacks", function()
    it("setOnClick accepts a function", function()
        local btn = luna.ui.newButton("Clickable")
        local clicked = false
...
-- 22. RadioButton
-- =========================================================================
describe("luna.ui.newRadioButton", function()
    it("creates a radio button", function()
        local rb = luna.ui.newRadioButton("Option A", "group1")
        expect_type("table", rb)
    end)
    it("has correct text", function()
        local rb = luna.ui.newRadioButton("Opt", "g")
        expect_equal("Opt", rb.getText())
    end)
    it("defaults to not selected", function()
        local rb = luna.ui.newRadioButton("X", "g")
    ...
    it("has group", function()
        local rb = luna.ui.newRadioButton("X", "mygroup")
        expect_equal("mygroup", rb.getGroup())
    end)
    it("has base widget methods", function()
        local rb = luna.ui.newRadioButton("A", "g")
...
-- 23. ScrollBar
-- =========================================================================
describe("luna.ui.newScrollBar", function()
    it("creates a scroll bar", function()
        local sb = luna.ui.newScrollBar(true)
    ...
    it("can set position", function()
        local sb = luna.ui.newScrollBar(false)
    ...
    it("vertical flag persists", function()
        local v = luna.ui.newScrollBar(true)
        local h = luna.ui.newScrollBar(false)
...
-- 24. GUIWindow
-- =========================================================================
describe("luna.ui.newWindow", function()
    it("creates a window", function()
        local w = luna.ui.newWindow("Title")
        expect_type("table", w)
    end)
    it("has correct title", function()
        local w = luna.ui.newWindow("My Win")
        expect_equal("My Win", w.getTitle())
    end)
    it("defaults closeable true", function()
        local w = luna.ui.newWindow("W")
...
-- 25. SplitPanel
-- =========================================================================
describe("luna.ui.newSplitPanel", function()
    it("creates a split panel", function()
        local sp = luna.ui.newSplitPanel("horizontal")
        expect_type("table", sp)
    end)
    it("has correct orientation", function()
        local sp = luna.ui.newSplitPanel("vertical")
...
-- 26. DockPanel
-- =========================================================================
describe("luna.ui.newDockPanel", function()
    it("creates a dock panel", function()
        local dp = luna.ui.newDockPanel()
...
-- 27. Toolbar
-- =========================================================================
describe("luna.ui.newToolbar", function()
    it("creates a toolbar", function()
        local tb = luna.ui.newToolbar("horizontal")
        expect_type("table", tb)
    end)
    it("has orientation", function()
        local tb = luna.ui.newToolbar("vertical")
...
-- 28. MenuBar
-- =========================================================================
describe("luna.ui.newMenuBar", function()
    it("creates a menu bar", function()
        local mb = luna.ui.newMenuBar()
    ...
    it("can add menu", function()
        local mb = luna.ui.newMenuBar()
        local mi = luna.ui.newMenuItem("File")
        mb.addMenu(mi._idx)
...
-- 29. MenuItem
-- =========================================================================
describe("luna.ui.newMenuItem", function()
    it("creates a menu item", function()
        local mi = luna.ui.newMenuItem("Edit")
...
-- 30. Dialog
-- =========================================================================
describe("luna.ui.newDialog", function()
    it("creates a dialog", function()
        local d = luna.ui.newDialog("Confirm")
        expect_type("table", d)
    end)
    it("has title", function()
        local d = luna.ui.newDialog("Save?")
        expect_equal("Save?", d.getTitle())
    end)
    it("defaults modal true", function()
        local d = luna.ui.newDialog("D")
    ...
    it("setContent and getContent work", function()
        local d = luna.ui.newDialog("Edit")
        local btn = luna.ui.newButton("B")
    ...
    it("setContent nil clears content", function()
        local d = luna.ui.newDialog("Clear")
        local btn = luna.ui.newButton("B")
        d.setContent(btn._idx)
        d.setContent(nil)
        expect_equal(nil, d.getContent())
    ...
    it("addButton appends footer button and returns count", function()
        local d = luna.ui.newDialog("Prompt")
...
-- 31. StatusBar
-- =========================================================================
describe("luna.ui.newStatusBar", function()
    it("creates a status bar", function()
        local sb = luna.ui.newStatusBar()
        expect_type("table", sb)
    end)
...
-- 32. Accordion
-- =========================================================================
describe("luna.ui.newAccordion", function()
    it("creates an accordion", function()
        local a = luna.ui.newAccordion()
        expect_type("table", a)
    end)
    it("starts with 0 sections", function()
        local a = luna.ui.newAccordion()
...
-- 33. TooltipPanel
-- =========================================================================
describe("luna.ui.newTooltipPanel", function()
    it("creates a tooltip panel", function()
        local tp = luna.ui.newTooltipPanel("Help text")
        expect_type("table", tp)
    end)
    it("has correct text", function()
        local tp = luna.ui.newTooltipPanel("Tip")
        expect_equal("Tip", tp.getText())
    end)
    it("can set text", function()
        local tp = luna.ui.newTooltipPanel("Old")
        tp.setText("New")
        expect_equal("New", tp.getText())
    end)
    it("default delay is 0.5", function()
        local tp = luna.ui.newTooltipPanel("T")
...
-- 34. ColorPicker
-- =========================================================================
describe("luna.ui.newColorPicker", function()
    it("creates a color picker", function()
        local cp = luna.ui.newColorPicker()
...
-- 35. GUITable
-- =========================================================================
describe("luna.ui.newTable", function()
    it("creates a table", function()
        local t = luna.ui.newTable()
        expect_type("table", t)
    end)
...
-- 36. ImageWidget
-- =========================================================================
describe("luna.ui.newImageWidget", function()
    it("creates an image widget", function()
        local iw = luna.ui.newImageWidget()
