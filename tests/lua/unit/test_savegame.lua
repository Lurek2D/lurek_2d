-- luna.savegame API unit tests
-- Headless-safe (no window / GPU / audio required).
-- Tests SaveManager lifecycle and API surface; does not write to disk.

describe("luna.savegame module exists", function()
    it("luna.savegame is a table", function()
        expect_type("table", luna.savegame)
    end)
end)

describe("Factory function", function()
    it("newSaveManager is a function", function()
        expect_type("function", luna.savegame.newSaveManager)
    end)
