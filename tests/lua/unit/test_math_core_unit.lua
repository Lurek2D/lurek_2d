...
describe("math.simplexNoise standalone", function()
    ...
    it("returns a number in range [-1, 1]", function()
        local v = lurek.procgen.simplexNoise(0.5, 0.5)
    ...
    it("is deterministic for same inputs", function()
        local v1 = lurek.procgen.simplexNoise(1.23, 4.56)
        local v2 = lurek.procgen.simplexNoise(1.23, 4.56)
        expect_near(v1, v2, 0.000001)
    end)

    -- @covers lurek.procgen.simplexNoise
    it("accepts 3 arguments", function()
        local v = lurek.procgen.simplexNoise(0.1, 0.2, 0.3)
        expect_type("number", v)
    end)
end)
...
describe("math.newNoiseGenerator", function()
    ...
    it("is deterministic", function()
        local ng1 = lurek.procgen.newNoiseGenerator(42)
    ...
    it("different seeds produce different values", function()
        local ng1 = lurek.procgen.newNoiseGenerator(42)
        local ng2 = lurek.procgen.newNoiseGenerator(999)
    ...
    it("generateMapCompute returns row-major array", function()
        local ng = lurek.procgen.newNoiseGenerator(123)
...
describe("math.newRectPacker", function()
    ...
    it("packs and reports occupancy", function()
        ...
        expect_equal(0, packer:occupancy())
    end)
end)
...
describe("math missing explicit coverage", function()
    ...
    it("math userdata helpers are callable", function()
        ...
        local nz = lurek.procgen.newNoiseGenerator(123)
...
describe("math strict uncovered symbols", function()
    ...
    it("strict scalar and geometry functions are callable", function()
        expect_type("number", lurek.procgen.perlin2d(0.1, 0.2))
        expect_type("number", lurek.procgen.perlin3d(0.1, 0.2, 0.3))
        expect_type("number", lurek.procgen.simplex2d(0.1, 0.2))
        expect_type("number", lurek.procgen.fbm(0.1, 0.2, 4, 0.5, 2.0))
    ...
    it("strict userdata methods are callable", function()
        ...
        local nz = lurek.procgen.newNoiseGenerator(99)
