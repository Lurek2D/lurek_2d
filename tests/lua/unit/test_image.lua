...
describe("luna.img.newLayeredImage", function()
...
describe("LayeredImage pixel editing via getLayer/setLayer", function()
    ...
    it("setLayer replaces layer pixels", function()
        local stack = luna.img.newLayeredImage(4, 4)
        stack:addLayer("x")
        local src = luna.img.newImageData(4, 4)
...
describe("LayeredImage:merge", function()
    ...
    it("hidden layer does not appear in merge", function()
        local stack = luna.img.newLayeredImage(4, 4)
        stack:addLayer("bg")
        local bg = luna.img.newImageData(4, 4)
        bg:fill(255, 0, 0, 255)
        stack:setLayer(1, bg)
        stack:addLayer("fg")
        local fg = luna.img.newImageData(4, 4)
        fg:fill(0, 0, 255, 255)
        stack:setLayer(2, fg)
    ...
    it("merge returns an ImageData of the same dimensions", function()
        local stack = luna.img.newLayeredImage(8, 6)
        local flat = stack:merge()
...
describe("luna.img.saveImage / luna.img.loadImage", function()
    it("saveImage and loadImage functions exist", function()
        expect_equal(type(luna.img.saveImage), "function")
        expect_equal(type(luna.img.loadImage), "function")
    end)
end)

describe("luna.img.saveLayered / luna.img.loadLayered", function()
    it("loadLayered function exists", function()
        expect_equal(type(luna.img.loadLayered), "function")
    end)
end)
