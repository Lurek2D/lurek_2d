...
-- -- setPosition --
-- @covers lurek.camera.newWalker, lurek.camera.walker.setPosition
...
-- -- getPosition --
-- @covers lurek.camera.newWalker, lurek.camera.walker.getPosition
...
-- -- setTilePosition --
-- @covers lurek.camera.newWalker, lurek.camera.walker.setTilePosition
...
-- -- getTilePosition --
-- @covers lurek.camera.newWalker, lurek.camera.walker.getTilePosition
...
-- -- moveUp --
-- @covers lurek.camera.newWalker, lurek.camera.walker.moveUp
...
-- -- moveDown --
-- @covers lurek.camera.newWalker, lurek.camera.walker.moveDown
...
-- -- moveLeft --
-- @covers lurek.camera.newWalker, lurek.camera.walker.moveLeft
...
-- -- moveRight --
-- @covers lurek.camera.newWalker, lurek.camera.walker.moveRight
...
-- -- update --
-- @covers lurek.camera.newWalker, lurek.camera.walker.update
...
-- -- getCamera --
-- @covers lurek.camera.newWalker, lurek.camera.walker.getCamera
...
-- -- type --
-- @covers lurek.camera.newWalker, lurek.camera.walker.type
...
-- -- typeOf --
-- @covers lurek.camera.newWalker, lurek.camera.walker.typeOf
