...
describe("ModManager object", function()
    it("newModManager returns a non-nil object", function()
        local mm = luna.modding.newModManager()
    ...
    it("registerMod adds a mod and getAllMods includes it", function()
        local mm = luna.modding.newModManager()
        local m = luna.modding.newMod({ id = "pack_a" })
        mm:registerMod(m)
    ...
    it("hasMod returns true after registerMod", function()
        local mm = luna.modding.newModManager()
        local m = luna.modding.newMod({ id = "unique_mod" })
        mm:registerMod(m)
    ...
    it("unregisterMod removes the mod", function()
        local mm = luna.modding.newModManager()
        local m = luna.modding.newMod({ id = "temp_mod" })
        mm:registerMod(m)
    ...
    it("getModCount increments after registerMod", function()
        local mm = luna.modding.newModManager()
        local m1 = luna.modding.newMod({ id = "m1" })
        local m2 = luna.modding.newMod({ id = "m2" })
        mm:registerMod(m1)
        mm:registerMod(m2)
