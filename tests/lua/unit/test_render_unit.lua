...
describe("render strict: batch text and OBJ APIs", function()
    ...
    it("loads OBJ model and exposes mesh projection methods", function()
        local obj = lurek.render.loadObj("lurek_2d_content/games/dungeon_crawler/assets/models/tank.obj")
        local mdl = lurek.render.loadModel("lurek_2d_content/games/dungeon_crawler/assets/models/tank.obj")
...
describe("render strict: LObjModel methods", function()
    local function load_obj_model()
        return lurek.render.loadObj("lurek_2d_content/games/dungeon_crawler/assets/models/tank.obj")
    end
