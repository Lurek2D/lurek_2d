...
describe("luna.graphics.saveScreenshot", function()
    it("accepts a save-relative path without error", function()
        local ok = pcall(luna.graphics.saveScreenshot, "save/test_graphics.png")
        expect_equal(ok, true)
    end)

    it("rejects paths outside save", function()
        expect_error(function()
            luna.graphics.saveScreenshot("test_graphics.png")
        end, "save/")
    end)
end)
