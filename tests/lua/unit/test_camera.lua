-- Luna2D Lua BDD tests for luna.camera
-- Headless: no GPU, no audio, no window.

describe("luna.camera", function()
    describe("module interface", function()
        it("exposes new factory", function()
            expect_type("function", luna.camera.new)
        end)
    end)
    ...
    describe("position", function()
        it("getPosition returns 0,0 by default", function()
            local cam = luna.camera.new(320, 240)
    ...
    describe("getVisibleArea()", function()
        it("returns four numbers x, y, w, h", function()
            local cam = luna.camera.new(640, 480)
