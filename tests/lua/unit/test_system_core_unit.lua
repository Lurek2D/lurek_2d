...
-- @describe lurek.runtime logging
...
-- @describe lurek.runtime platform info
describe("lurek.runtime platform info", function()
    ...
    it("openURL is exposed as a function", function()
...
-- @describe lurek.runtime debug and log level
...
-- @describe lurek.runtime environment and args
