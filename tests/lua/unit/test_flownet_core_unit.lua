...
-- 1. Module existence
-- =========================================================================
-- @describe lurek.flownet module exists
describe("lurek.flownet module exists", function()
    -- @covers lurek.flownet
    it("lurek.flownet is a table", function()
        expect_type("table", lurek.flownet)
    end)
...
-- @describe lurek.graph.newGraph
describe("lurek.graph.newGraph", function()
    -- @covers lurek.graph.newGraph
    it("creates an empty graph", function()
        local g = lurek.graph.newGraph()
        expect_not_nil(g, "graph must not be nil")
        expect_equal(0, g:getNodeCount())
    end)
end)

-- @describe lurek.graph.addNode
describe("lurek.graph.addNode", function()
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("adds a node and increments node count", function()
        local g = lurek.graph.newGraph()
        local n = g:addNode("city", 5)
    ...
    it("adds multiple nodes", function()
        ...
        g:addNode("b")
        g:addNode("c")
        expect_equal(3, g:getNodeCount())
    end)
end)

-- @describe lurek.graph.addEdge
describe("lurek.graph.addEdge", function()
    -- @covers lurek.graph.addEdge
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("connects two nodes with an edge", function()
        local g = lurek.graph.newGraph()
        local a = g:addNode("src")
        local b = g:addNode("dst")
        local e = g:addEdge(a, b)
    ...
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("supports typed edges", function()
        local g = lurek.graph.newGraph()
        local a = g:addNode()
        local b = g:addNode()
        local e = g:addEdge(a, b, "road")
        expect_not_nil(e, "typed edge must not be nil")
    end)
end)

-- @describe lurek.graph.removeNode
describe("lurek.graph.removeNode", function()
    -- @covers lurek.graph.removeNode
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("removes a node and decrements count", function()
        local g = lurek.graph.newGraph()
        local n = g:addNode()
        expect_equal(1, g:getNodeCount())
        g:removeNode(n)
...
-- @describe lurek.graph.astar
describe("lurek.graph.astar", function()
    -- @covers lurek.graph.astar
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.addEdge
    -- @covers lurek.graph.newGraph
    it("finds a path between connected nodes", function()
        local g = lurek.graph.newGraph()
        local a = g:addNode("start")
    ...
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("returns nil for disconnected nodes", function()
        local g = lurek.graph.newGraph()
        local a = g:addNode("island1")
        local b = g:addNode("island2")
        local path = g:astar(a, b)
        expect_true(path == nil, "no path between disconnected nodes")
    end)
end)

-- @describe lurek.graph.getNodeCount
describe("lurek.graph.getNodeCount", function()
    -- @covers lurek.graph.getNodeCount
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("accurately reflects number of nodes", function()
        local g = lurek.graph.newGraph()
        expect_equal(0, g:getNodeCount())
        g:addNode()
        g:addNode()
...
-- @describe lurek.graph.getNodes
describe("lurek.graph.getNodes", function()
    -- @covers lurek.graph.getNodes
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.newGraph
    it("returns a table containing all added nodes", function()
        local g = lurek.graph.newGraph()
        g:addNode("x")
        g:addNode("y")
        local nodes = g:getNodes()
        expect_equal(2, #nodes)
    end)
end)

-- @describe lurek.graph.getEdges
describe("lurek.graph.getEdges", function()
    -- @covers lurek.graph.getEdges
    -- @covers lurek.graph.addNode
    -- @covers lurek.graph.addEdge
    -- @covers lurek.graph.newGraph
...
describe("batch operations", function()
    ...
    it("batchAddNodes creates multiple nodes", function()
        local g = lurek.graph.newGraph()
        local ids = g:batchAddNodes(5, { capacity = 100 })
        expect_equal(5, #ids)
        expect_true(ids[1] > 0)
        expect_equal(5, g:getNodeCount())
    end)

    -- @covers LGraph:batchAddNodes
    it("batchAddNodes works without config", function()
        local g = lurek.graph.newGraph()
    ...
    it("batchAddEdges creates edges from table", function()
        local g = lurek.graph.newGraph()
        local ids = g:batchAddNodes(3)
    ...
    it("batchStep runs multiple iterations", function()
        local g = lurek.graph.newGraph()
        local n1 = g:addNode("source", -1)
        local n2 = g:addNode("sink", 100)
        g:addEdge(n1, n2)
        g:batchStep(0.016, 10) -- 10 frames at 60fps
        -- No crash = pass
        expect_true(true)
    end)
end)
...
-- =========================================================================
-- Graph addEdgeUnchecked
-- =========================================================================

-- @describe Graph addEdgeUnchecked
describe("Graph addEdgeUnchecked", function()
    -- @covers LGraph:addEdgeUnchecked
    it("addEdgeUnchecked creates edge without node existence validation", function()
        local g = lurek.graph.newGraph()
        local n1 = g:addNode("source", -1)
        local n2 = g:addNode("sink", -1)
        local e = g:addEdgeUnchecked(n1, n2)
        expect_type("userdata", e)
    end)

    -- @covers LGraph:addEdgeUnchecked
    it("addEdgeUnchecked with explicit edge type sets type correctly", function()
        local g = lurek.graph.newGraph()
        local n1 = g:addNode("a", -1)
        local n2 = g:addNode("b", -1)
        local e = g:addEdgeUnchecked(n1, n2, "pipe")
        expect_equal("pipe", e:getType())
    end)
end)
