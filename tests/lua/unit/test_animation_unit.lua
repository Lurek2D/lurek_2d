...
-- BEGIN test_animation_core_unit.lua
do
...
describe("animation source adapters", function()
    ...
    it("fromAnimatedImage consumes decoded animated image frames", function()
        ...
        a:fill(255, 0, 0, 255)
        b:fill(0, 255, 0, 255)
        lurek.image.saveGIF({ a, b }, "save/test_animation_from_animated.gif", { delayMs = 30 })
        local decoded = lurek.image.loadAnimated("save/test_animation_from_animated.gif")
