-- Luna2D luna.light.* API Tests

-- ── Module-level functions ────────────────────────────────────────────────

describe("luna.light module functions", function()
    it("luna.light is a table", function()
        expect_type("table", luna.light)
    end)

    it("newLight returns userdata", function()
        luna.light.clear()
        local l = luna.light.newLight(100, 200, 50)
    ...
    it("newLight with opts applies settings", function()
        luna.light.clear()
        local l = luna.light.newLight(10, 20, 30, {
    ...
    it("newOccluder returns userdata for valid polygon", function()
        luna.light.clear()
        local o = luna.light.newOccluder({0, 0, 100, 0, 50, 80})
    ...
    it("newOccluder errors on fewer than 6 numbers", function()
        expect_error(function()
            luna.light.newOccluder({0, 0, 100, 0})
        end)
    end)

    it("newOccluder errors on odd number count", function()
        expect_error(function()
            luna.light.newOccluder({0, 0, 100, 0, 50})
        end)
    end)

    it("setAmbient / getAmbient round-trip (rgb)", function()
        luna.light.clear()
        luna.light.setAmbient(0.3, 0.4, 0.5)
        local r, g, b, a = luna.light.getAmbient()
    ...
    it("setAmbient / getAmbient round-trip (rgba)", function()
        luna.light.clear()
        luna.light.setAmbient(0.2, 0.3, 0.4, 0.8)
        local r, g, b, a = luna.light.getAmbient()
    ...
    it("setEnabled / isEnabled round-trip", function()
        luna.light.clear()
        luna.light.setEnabled(false)
        expect_false(luna.light.isEnabled())
        luna.light.setEnabled(true)
        expect_true(luna.light.isEnabled())
    end)
    ...
    it("auto-enables after first newLight", function()
        ...
        luna.light.setEnabled(false)
        expect_false(luna.light.isEnabled())
        local l = luna.light.newLight(0, 0, 10)
        expect_true(luna.light.isEnabled())
        l:remove()
    end)
    ...
    it("getLightCount tracks add/remove", function()
        luna.light.clear()
        expect_equal(luna.light.getLightCount(), 0)
        local l1 = luna.light.newLight(0, 0, 10)
        expect_equal(luna.light.getLightCount(), 1)
        local l2 = luna.light.newLight(50, 50, 20)
        expect_equal(luna.light.getLightCount(), 2)
        l1:remove()
        expect_equal(luna.light.getLightCount(), 1)
        l2:remove()
        expect_equal(luna.light.getLightCount(), 0)
    ...
    it("getOccluderCount tracks add/remove", function()
        luna.light.clear()
        expect_equal(luna.light.getOccluderCount(), 0)
        local o1 = luna.light.newOccluder({0, 0, 10, 0, 5, 10})
        expect_equal(luna.light.getOccluderCount(), 1)
        local o2 = luna.light.newOccluder({20, 20, 30, 20, 25, 30})
        expect_equal(luna.light.getOccluderCount(), 2)
        o1:remove()
        expect_equal(luna.light.getOccluderCount(), 1)
        o2:remove()
        expect_equal(luna.light.getOccluderCount(), 0)
    ...
    it("getMaxLights / setMaxLights round-trip", function()
        luna.light.clear()
        luna.light.setMaxLights(128)
        expect_equal(luna.light.getMaxLights(), 128)
    end)

    it("setMaxLights clamps to 1..256", function()
        luna.light.setMaxLights(0)
        expect_equal(luna.light.getMaxLights(), 1)
        luna.light.setMaxLights(999)
        expect_equal(luna.light.getMaxLights(), 256)
    end)

    it("clear resets counts and ambient", function()
        local l = luna.light.newLight(0, 0, 10)
        local o = luna.light.newOccluder({0, 0, 10, 0, 5, 10})
        luna.light.setAmbient(1.0, 1.0, 1.0)
        luna.light.clear()
        expect_equal(luna.light.getLightCount(), 0)
        expect_equal(luna.light.getOccluderCount(), 0)
        local r, g, b, a = luna.light.getAmbient()
...
describe("Occluder handle methods", function()
    ...
    it("getVertices returns flat table", function()
        luna.light.clear()
        local o = luna.light.newOccluder({10, 20, 30, 40, 50, 60})
...
describe("luna.light edge cases", function()
...
describe("Light type", function()
    it("default is point", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50)
...
describe("Light groups", function()
    ...
    it("getGroupCount returns count", function()
        luna.light.clear()
        local l1 = luna.light.newLight(0, 0, 50)
        local l2 = luna.light.newLight(10, 10, 50)
        l1:setGroupId(1)
        l2:setGroupId(1)
        expect_equal(luna.light.getGroupCount(1), 2)
        expect_equal(luna.light.getGroupCount(0), 0)
        luna.light.clear()
    end)
    ...
    it("setGroupEnabled disables a group", function()
        ...
        local l1 = luna.light.newLight(0, 0, 50)
        local l2 = luna.light.newLight(10, 10, 50)
        local l3 = luna.light.newLight(20, 20, 50)
        l1:setGroupId(2)
        l2:setGroupId(2)
        -- l3 stays group 0
        luna.light.setGroupEnabled(2, false)
    ...
    it("setGroupIntensity changes group intensity", function()
        ...
        local l1 = luna.light.newLight(0, 0, 50)
        l1:setGroupId(3)
        luna.light.setGroupIntensity(3, 0.5)
    ...
    it("setGroupColor changes group color", function()
        ...
        local l1 = luna.light.newLight(0, 0, 50)
        l1:setGroupId(4)
        luna.light.setGroupColor(4, 1.0, 0.0, 0.0, 1.0)
...
describe("advanceFlickers", function()
    it("advanceFlickers does not error", function()
        ...
        luna.light.advanceFlickers(0.1)
...
describe("newLight opts with new effects", function()
    it("opts type sets light type", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50, { type = "spot" })
        expect_equal(l:getLightType(), "spot")
        l:remove()
    end)
    ...
    it("opts direction sets direction", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50, { direction = 1.57 })
        expect_near(l:getDirection(), 1.57, 0.001)
        l:remove()
    end)
    ...
    it("opts innerAngle and outerAngle", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50, { innerAngle = 0.3, outerAngle = 0.6 })
        expect_near(l:getInnerAngle(), 0.3, 0.001)
        expect_near(l:getOuterAngle(), 0.6, 0.001)
        l:remove()
    end)
    ...
    it("opts groupId sets group", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50, { groupId = 7 })
    ...
    it("opts volumetric sets flag", function()
        luna.light.clear()
        local l = luna.light.newLight(0, 0, 50, { volumetric = true })
        expect_equal(l:isVolumetric(), true)
        l:remove()
    end)
