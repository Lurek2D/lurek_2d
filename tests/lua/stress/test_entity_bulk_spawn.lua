-- Lurek2D Lua stress test for lurek.entity spawnBulk
-- Headless: no GPU, no audio, no window.

-- @description Covers suite: lurek.entity spawnBulk stress.
describe("lurek.entity.spawnBulk", function()
    -- @covers lurek.entity.newUniverse
    -- @covers lurek.entity.defineBlueprint
    -- @covers lurek.entity.spawnBulk
