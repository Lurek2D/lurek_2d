-- Lua test harness helpers for tests that require("tests.lua.harness").
-- The runtime test runner is implemented in Rust; this file exposes the
-- assertion aliases used by the Lua suites.
