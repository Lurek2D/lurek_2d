...
describe("lurek.devtools logger", function()
    ...
    it("getLogHistory respects count and filtered logging", function()
        lurek.devtools.clearLog()
        lurek.devtools.setLogConsole(false)
        ...
        local filtered = lurek.devtools.getLogHistory()
        expect_equal(0, #filtered)
        lurek.devtools.setLogLevel("info")
        lurek.devtools.setLogConsole(true)
    end)
end)
...
describe("lurek.devtools frame stats", function()
    ...
    it("can change and clamp frame history size", function()
...
describe("lurek.devtools debug bridge", function()
    ...
    it("eval succeeds for valid code and fails for invalid code", function()
