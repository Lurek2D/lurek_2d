-- Headless contract test for demo_game (content/games/showcase/demo_game)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: demo_game
describe("demo: demo_game", function()
    local DEMO = "content/games/showcase/demo_game"
