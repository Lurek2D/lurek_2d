-- Headless contract test for platformer (content/games/action/platformer)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: platformer
describe("demo: platformer", function()
    local DEMO = "content/games/action/platformer"
