-- Headless contract test for physics_demo (content/games/simulation/physics_demo)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: physics_demo
describe("demo: physics_demo", function()
    local DEMO = "content/games/simulation/physics_demo"
