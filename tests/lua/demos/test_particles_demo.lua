-- Headless contract test for particles_demo (content/games/showcase/particles_demo)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: particles_demo
describe("demo: particles_demo", function()
    local DEMO = "content/games/showcase/particles_demo"
