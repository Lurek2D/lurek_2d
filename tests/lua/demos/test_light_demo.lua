-- Headless contract test for light_demo (content/games/showcase/light_demo)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: light_demo
describe("demo: light_demo", function()
    local DEMO = "content/games/showcase/light_demo"
