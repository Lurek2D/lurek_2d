-- Headless contract test for html-load-document (content/games/showcase/html-load-document)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: html-load-document
describe("demo: html-load-document", function()
    local DEMO = "content/games/showcase/html-load-document"
