-- Headless contract test for html-scoreboard (content/games/showcase/html-scoreboard)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: html-scoreboard
describe("demo: html-scoreboard", function()
    local DEMO = "content/games/showcase/html-scoreboard"
