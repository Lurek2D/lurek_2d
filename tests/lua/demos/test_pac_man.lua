-- Headless contract test for pac_man (content/games/arcade/pac_man)
dofile("tests/lua/demos/_common_checks.lua")

-- @describe demo: pac_man
describe("demo: pac_man", function()
    local DEMO = "content/games/arcade/pac_man"
