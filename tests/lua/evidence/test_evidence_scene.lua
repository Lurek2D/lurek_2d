...
-- Produces: tests/lua/evidence/output/scene/depth_sort_order.txt
--           tests/lua/evidence/output/scene/stable_sort_order.txt
--
...
local OUT = "tests/lua/evidence/output/scene/"
...
describe("Evidence: lurek.scene DepthSorter sort order", function()
    ...
    it("stable_sort_order.txt: equal depths preserve insertion order", function()
        ...
        -- Three items at the same depth — insertion order must be preserved.
