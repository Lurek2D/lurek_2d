...
describe("Evidence: lurek.ai data outputs", function()
    ...
    it("writes ai_constructor_surface_snapshot.txt", function()
        local lines = {
            ...
            "ai_steering_ctor=" .. tostring(type(lurek.ai.newSteeringManager) == "nil"),
            "ai_influence_ctor=" .. tostring(type(lurek.ai.newInfluenceMap) == "nil"),
            "ai_context_steering_ctor=" .. tostring(type(lurek.ai.newContextSteering) == "nil"),
            "ai_orca_ctor=" .. tostring(type(lurek.ai.newORCASolver) == "nil"),
