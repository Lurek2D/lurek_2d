...
describe("math.vec3", function()
    ...
    -- @integration LVec3:lengthSquared
    -- @integration lurek.math.vec3
...
describe("math.catmullRom", function()
    ...
    -- @integration LCatmullRom:sample
    -- @integration lurek.math.catmullRom
    ...
    -- @integration LCatmullRom:sampleSegment
    -- @integration lurek.math.catmullRom
