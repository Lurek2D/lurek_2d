...
local function build_visibility()
    ...
    local visibility = lurek.visibility.newTileVisibility(field, { players = { "p1" }, rememberExplored = true })
...
-- @describe visibility_minimap library
describe("visibility_minimap library", function()
    -- @library lurek.library_visibility_minimap
    it("syncs visible and explored cells into minimap fog data", function()
        local helper = VisibilityMinimap.new({ visibility = build_visibility(), width = 5, height = 4 })
