...
impl LuaUserData for LuaLight2D {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        ///
        /// # Parameters
        /// - `x` ÔÇö `number`: World X coordinate.
        /// - `y` ÔÇö `number`: World Y coordinate.
        ...
        ///
        /// # Parameters
        /// - `radius` ÔÇö `number`: Radius in world units.
        ...
        ///
        /// # Parameters
        /// - `enabled` ÔÇö `boolean`: `true` to enable.
...
impl LuaUserData for LuaViewport {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        ///
        /// # Parameters
        /// - `wx` ÔÇö `number`: World X.
        /// - `wy` ÔÇö `number`: World Y.
        ///
        /// # Returns
...
impl LuaUserData for LuaSpriteSheet {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // getRange(start, count) ÔÇö 1-based start
        /// Returns the range.
        /// @param start : integer
        /// @param count : integer
        ///
        ...
        // nameGroup(name, startFrame, count) ÔÇö 1-based startFrame
        methods.add_method(
            "nameGroup",
        ...
        // getDirectionFrames(direction) ÔÇö 1-based
        /// Returns the direction frames.
        /// @param direction : integer
        /// @return any
        ///
        /// # Parameters
        /// - `direction` ÔÇö `integer`.
        ///
        /// # Returns
...
impl LuaUserData for LuaLargeMapRenderer {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // setMapData(data, width, height) ÔÇö data: flat table of 1-based tile IDs
        methods.add_method(
            "setMapData",
        ...
        // setTile(x, y, tileId) ÔÇö 1-based coords and tileId
        /// Sets the tile.
        /// @param x : integer
        /// @param y : integer
        ...
        // getTile(x, y) ÔÇö 1-based coords, returns 1-based tileId
        /// Returns the tile.
        /// @param x : integer
        /// @param y : integer
        /// @return any
...
impl LuaUserData for LuaColumnBatch {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // setColumn(col, texU, start, end, shade?, cellVal?) ÔÇö 1-based col
        methods.add_method(
            "setColumn",
            |_,
             this,
...
impl LuaUserData for LuaAnimation {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // addFrame(x, y, w, h) Ôćĺ 1-based index
        ...
        // addClip(name, frames, fps, loop?) ÔÇö frames: 1-based indices
        methods.add_method(
            "addClip",
        ...
        // addFramesFromGrid(texW, texH, frameW, frameH, start?, count?) ÔÇö 1-based start
        methods.add_method(
            "addFramesFromGrid",
            |_,
             this,
        ...
        // addClipFromGrid(name, texW, texH, frameW, frameH, start, count, fps, loop?) ÔÇö 1-based start
        methods.add_method(
            "addClipFromGrid",
            |_,
             this,
...
///
/// # Fields
/// - `inner` ÔÇö `Rc<RefCell<DecalSurface>>`.
#[derive(Clone)]
...
///
/// # Fields
/// - `inner` ÔÇö `Rc<RefCell<PaletteLUT>>`.
#[derive(Clone)]
