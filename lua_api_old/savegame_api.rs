...
impl mlua::UserData for LuaSaveManager {
    fn add_methods<'lua, M: mlua::UserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // ÔöÇÔöÇ Slot-based File I/O ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

        // save(slot) ÔÇö collect all data, serialize to Lua, write to save/slot_{name}.sav
        ...
        // load(slot) Ôćĺ boolean, string? ÔÇö load save file, restore, run migrations
        ...
        // delete(slot) ÔÇö remove the save file
        ...
        // getSlots() Ôćĺ table of slot info tables
        ...
        // getSlotInfo(slot) Ôćĺ table|nil ÔÇö metadata without full restore
...
///
/// # Parameters
/// - `lua` ÔÇö `&Lua`. The active Lua VM.
/// - `luna` ÔÇö `&LuaTable`. The top-level `luna` table.
/// - `state` ÔÇö `Rc<RefCell<SharedState>>`. Shared engine state.
///
/// # Returns
/// `LuaResult<()>`.
