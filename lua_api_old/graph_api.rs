...
impl LuaUserData for LuaGraph {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        ///
        /// # Parameters
        /// - `from_ud` ÔÇö `userdata`.
        /// - `to_ud` ÔÇö `userdata`.
        /// - `edge_type` ÔÇö `string` optional.
        ///
        /// # Returns
...
impl LuaUserData for LuaGraphItem {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // Multi-value return: AtNode Ôćĺ (LuaNode), InTransit Ôćĺ (LuaEdge, progress), Unplaced Ôćĺ ()
