...
impl LuaUserData for LuaDataFrame {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        ...
        // -- Row operations (1-based Lua Ôćĺ 0-based Rust) ---------------------
        ...
        methods.add_method("slice", |_, this, (start, end): (usize, usize)| {
            // Lua 1-based inclusive Ôćĺ Rust 0-based inclusive
            if start == 0 || end == 0 {
...
pub fn register(lua: &Lua, luna: &LuaTable) -> LuaResult<()> {
    ...
    // luna.dataframe.fromTable(t) ÔÇö array of row-tables
    /// From table.
    ///
    /// @param tbl : table
    /// @return any
