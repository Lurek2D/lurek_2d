...
function registerLibraryCommands(context) {
    // ── luna.library.browse ──────────────────────────────────
    context.subscriptions.push(vscode.commands.registerCommand("luna.library.browse", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.library.insertSnippet", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.library.newPattern", async () => {
        const editor = vscode.window.activeTextEditor;
