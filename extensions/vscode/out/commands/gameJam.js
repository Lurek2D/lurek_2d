...
function registerGameJamCommands(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.gameJam.quickStart", async () => {
        // Pick template
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.gameJam.addModule", async () => {
    ...
    // ── luna.gameJam.timer ───────────────────────────────────
    context.subscriptions.push(vscode.commands.registerCommand("luna.gameJam.timer", async () => {
