...
class LunaProcessService {
    ...
    async findLunaBinary() {
        ...
        // 2. Check PATH for lurek / lurek.exe
        const binaryName = process.platform === "win32" ? "lurek.exe" : "lurek";
        ...
        throw new Error("Luna2D binary not found. Install it or set lurek.lunaPath in settings.");
    }
    /**
