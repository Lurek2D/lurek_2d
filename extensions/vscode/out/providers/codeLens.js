...
function register(context, _apiData) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.codelens.findRefs", async (_uri, pos) => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("luna.codeLens.toggle", () => {
