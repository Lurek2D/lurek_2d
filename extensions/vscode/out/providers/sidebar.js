...
class ProjectToolsProvider {
    ...
    getChildren(element) {
        ...
        switch (element.label) {
            case "Create":
                return [
                    new SidebarItem("New Project from Template", vscode.TreeItemCollapsibleState.None, "luna.scaffold.project", "file-add"),
                    new SidebarItem("New File from Template", vscode.TreeItemCollapsibleState.None, "luna.scaffold.file", "new-file"),
                ];
            case "Package":
                return [
                    new SidebarItem("Package .zip", vscode.TreeItemCollapsibleState.None, "luna.package.zip", "file-zip"),
                    new SidebarItem("Package for Windows", vscode.TreeItemCollapsibleState.None, "luna.package.windows", "desktop-download"),
                    new SidebarItem("Package for Linux", vscode.TreeItemCollapsibleState.None, "luna.package.linux", "terminal-linux"),
                ];
            case "Libraries":
                return [
                    new SidebarItem("Install Library", vscode.TreeItemCollapsibleState.None, "luna.library.install", "cloud-download"),
                    new SidebarItem("List Libraries", vscode.TreeItemCollapsibleState.None, "luna.library.list", "list-unordered"),
                ];
            default:
                return [];
        }
...
class DevToolsProvider {
    ...
    getChildren(element) {
        ...
        switch (element.label) {
            case "Run":
                return [
                    new SidebarItem("Run Game", vscode.TreeItemCollapsibleState.None, "luna.runGame", "play"),
                    new SidebarItem("Stop Game", vscode.TreeItemCollapsibleState.None, "luna.stopGame", "debug-stop"),
                    new SidebarItem("Run with Arguments", vscode.TreeItemCollapsibleState.None, "luna.runWithArgs", "terminal"),
                    new SidebarItem("Run Example", vscode.TreeItemCollapsibleState.None, "luna.runExample", "file-code"),
                ];
            case "Testing":
                return [
                    new SidebarItem("Open Test Runner", vscode.TreeItemCollapsibleState.None, "luna.editor.testRunner", "beaker"),
                    new SidebarItem("Run All Tests", vscode.TreeItemCollapsibleState.None, "luna.test.all", "testing-run-all-icon"),
                    new SidebarItem("Run Lua Tests", vscode.TreeItemCollapsibleState.None, "luna.test.lua.all", "test-view-icon"),
                    new SidebarItem("Run Golden Tests", vscode.TreeItemCollapsibleState.None, "luna.test.lua.golden", "file-media"),
                    new SidebarItem("Generate Tests for File", vscode.TreeItemCollapsibleState.None, "luna.test.generateForFile", "wand"),
                ];
            case "Editors":
                return [
                    // ── Level / World ─────────────────────────────────────
