...
exports.openWatchersPanel = openWatchersPanel;
exports.addWatchFromEditor = addWatchFromEditor;
...
async function refreshAll() {
    if (!_evalFn || !_connected || _watches.length === 0)
        return;
...
//# sourceMappingURL=debugWatchers.js.map