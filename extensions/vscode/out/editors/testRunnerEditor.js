...
exports.TestRunnerEditor = void 0;
...
class TestRunnerEditor extends shared_js_1.WebviewEditor {
    static open(context) {
    ...
    handleMessage(msg) {
        switch (msg.type) {
            ...
            case "runAll":
                ...
                break;
            case "runSuite":
                this.runCargoTest(msg.suite, msg.suite);
                break;
            case "runLua":
    ...
    discoverTestSuites() {
        ...
        for (const file of files.sort()) {
            if (!file.endsWith("_tests.rs"))
                continue;
            const suiteName = file.replace(/\.rs$/, "");
            if (special.has(suiteName))
    ...
    getHtml() {
        ...
        return (0, shared_js_1.wrapHtml)(nonce, "Test Runner", `
      .editor-layout {
...
exports.TestRunnerEditor = TestRunnerEditor;
//# sourceMappingURL=testRunnerEditor.js.map