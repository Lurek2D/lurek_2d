...
exports.SoundDspEditor = void 0;
const vscode = __importStar(require("vscode"));
const shared_js_1 = require("./shared.js");
class SoundDspEditor extends shared_js_1.WebviewEditor {
    static open(context) {
    ...
    getHtml() {
        ...
        return (0, shared_js_1.wrapHtml)(nonce, "Sound DSP Panel", `
    ...
    `, `
      ...
      function updateCode() {
        ...
        if (currentTab === 'chain') {
          ...
          code += '})\\n\\n';
          code += '-- Play immediately:\\nluna.sound.play(lurek.sound.fromSynth(synth))';
        }
...
exports.SoundDspEditor = SoundDspEditor;
//# sourceMappingURL=soundDspEditor.js.map