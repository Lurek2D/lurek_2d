...
function buildEditorItems(): SidebarItem[] {
  return [
    ...
    new SidebarItem("Province Editor", vscode.TreeItemCollapsibleState.None, "lurek.editor.province", "map-filled"),
    new SidebarItem("Globe Editor", vscode.TreeItemCollapsibleState.None, "lurek.editor.globe", "globe"),
...
export class SidebarItem extends vscode.TreeItem {
  constructor(
    ...
    if (commandId) {
      const tooltipText = COMMAND_TOOLTIPS[commandId] ?? EDITOR_COMMAND_TOOLTIPS[commandId];
      if (tooltipText) {
    ...
    switch (element.label) {
      ...
      case "Reference":
        return [
          ...
          new SidebarItem("API Coverage", vscode.TreeItemCollapsibleState.None, "lurek.editor.apiCoverage", "graph-line"),
        ];
      case "Assets":
        return [
