...
- **`cleanup_prompt_catalog.py`**: Remove deprecated prompts and rename remaining create-oriented prompts.
- **`prompt_scope_report.py`**: Report active prompt scope and flag deprecated analysis-style prompts.
...
- **`validate_rust_source_docs.py`**: Validate file-level and public-item Rust docs-general under src/.
