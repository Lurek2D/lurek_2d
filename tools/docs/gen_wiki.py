...
STATIC_ORDER = [
    ...
    "Runtime-Model", "Modules", "API", "Examples",
...
def home_page(context: Context) -> Page:
    ...
    body = [
        ...
        f"4. {wiki('API')} - where to find the official full API reference.",
        "",
        "## Wiki Map",
        "",
...
def api_page(context: Context) -> Page:
    ...
    body = [
        ...
        "",
        f"- Full Markdown reference: {file_link(context, API_MARKDOWN, 'docs/api/lurek.md')} ({context.api_markdown_lines} lines)",
        f"- LuaCATS editor stub: {file_link(context, API_STUB, 'docs/api/lurek.lua')} ({context.api_stub_lines} lines)",
        f"- Runtime callbacks: {file_link(context, ROOT / 'docs' / 'api' / 'callbacks.md', 'docs/api/callbacks.md')}",
        f"- Lureksome library API: {file_link(context, LIBRARY_DOC, 'docs/api/lureksome.md')}",
        f"- Machine-readable Lua API data: {file_link(context, API_DATA, 'build/docs-data/lua_api.json')}",
        "",
        "## Coverage",
        "",
...
def sidebar_page(context: Context) -> Page:
    ...
    lines += ["", "**API Map**", "", "* " + wiki("API"), "", "**Examples And Games**", "", "* " + wiki("Examples"), "* " + wiki("Reference-Games", "Reference Games"), "", "**Libraries**", "", "* " + wiki("Lureksome")]
