...
- `audit/gen_demo_lua_tests.py` - Generate tests/lua_reorg/demos/test_*.lua from demo_smoke_tests.rs paths. [durable; mcp:no]
...
- `audit/lua_nonunit_test_coverage.py` - lua_nonunit_test_coverage.py - Audit canonical non-unit Lua tests in tests/lua_reorg. [durable; mcp:no]
...
- `audit/lua_test_structure_audit.py` - Audit and normalize Lua BDD test structure under tests/lua_reorg_reorg. [durable; mcp:no]
